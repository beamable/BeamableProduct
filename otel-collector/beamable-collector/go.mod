module github.com/beamable/BeamableProduct/otel-collector/beamable-collector
...
require (
	github.com/beamable/BeamableProduct/servicediscovery v0.0.0
...
replace github.com/beamable/BeamableProduct/servicediscovery => ../Extensions/ServiceDiscovery

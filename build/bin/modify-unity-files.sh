...
sed "s/BUILD__SDK__VERSION__STRING/'${VERSION}'/" client/Packages/com.beamable/Runtime/Environment/Resources/env-default.json

# update the com.beamable.server dependency on com.beamable
sed "s/BUILD__SDK__VERSION__STRING/'${VERSION}'/" client/Packages/com.beamable.server/package.json

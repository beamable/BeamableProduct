...
then 
    ...
    dotnet nuget push ./microservice/unityEngineStubs.addressables/nupkg/Beamable.UnityEngine.${VERSION}.nupkg --source https://api.nuget.org/v3/index.json --api-key ${NUGET_TOOLS_KEY}
    dotnet nuget push ./microservice/unityEngineStubs.addressables/nupkg/Beamable.UnityEngine.${VERSION}.snupkg --source https://api.nuget.org/v3/index.json --api-key ${NUGET_TOOLS_KEY}

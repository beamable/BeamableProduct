import Foundation
import React
// The Swift core is compiled into this same pod/module (see the podspec), so its
// types (NotificationManager, LocalRequest, JSON, …) are available directly —
// no `import BeamableNotifications`.

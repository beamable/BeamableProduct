...
-keepclassmembers class com.beamable.push.unity.UnityPushBridge { *; }
...
# The bundled React Native adapter (com.beamable.push.react) references react classes that are
# absent in a Unity/Unreal app; never loaded there, so silence the missing-class warnings.

...
public class GenerateEnvFileCommand : AtomicCommand<GenerateEnvFileCommandArgs, GenerateEnvFileOutput>, ISkipManifest
{
	...
	public override async Task<GenerateEnvFileOutput> GetResult(GenerateEnvFileCommandArgs args)
	{
		...
		var otelAuthReq = beamoApi.GetOtelAuthWriterConfig();
		...
		var output = new GenerateEnvFileOutput
		{
			envVars = new List<EnvVarOutput>
			{
				...
				EnvVarOutput.Create(Beamable.Common.Constants.Features.Otel.ENV_COLLECTOR_CLICKHOUSE_ENDPOINT, otelAuth.endpoint),
				EnvVarOutput.Create(Beamable.Common.Constants.Features.Otel.ENV_COLLECTOR_CLICKHOUSE_USERNAME, otelAuth.username),
				EnvVarOutput.Create(Beamable.Common.Constants.Features.Otel.ENV_COLLECTOR_CLICKHOUSE_PASSWORD, otelAuth.password),
			}
		};

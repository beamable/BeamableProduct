...
public class HttpMicroserviceLocalProtocol : IBeamoLocalProtocol
{
	...
	/// <summary>
	/// A list of paths to Unity Assembly Deifnition project paths.
	/// These projects are auto generated by the Bemable Unity SDK when an assembly
	/// definition is referenced to a microservice through Project Settings.
	/// </summary>
	public List<string> UnityAssemblyDefinitionProjectPaths = new List<string>();

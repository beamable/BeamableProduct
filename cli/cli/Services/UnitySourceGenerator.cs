...
public static class UnityHelper
{
	...
	private const string BeamableGeneratedNamespace = "Beamable.Api.Autogenerated";
	...
	public static CodeTypeDeclaration GenerateEnumExtensions(string name, OpenApiSchema schema)
	{
		...
		var toStringMethod = new CodeMemberMethod
			{
				Name = "ToString", Attributes = MemberAttributes.Static | MemberAttributes.Public, ReturnType = new CodeTypeReference(typeof(string))
			};
		...
		var fromStringMethod = new CodeMemberMethod
			{
				Name = "FromString", Attributes = MemberAttributes.Static | MemberAttributes.Public, ReturnType = enumType
			};
	...
	private static bool GetSerializationMethodReference(OpenApiSchema schema, out CodeMethodReferenceExpression methodExpr, out List<CodeExpression> parameters)
	{
		...
		switch (schema.Type)
		{
			case "string" when schema.Enum?.Count > 0:
				...
				parameters.Add(new CodeMethodReferenceExpression(extensionClass,"ToString"));
				parameters.Add(new CodeMethodReferenceExpression(extensionClass,"FromString"));

...
public class SortedJsonElementConverter : JsonConverter<JsonElement>
{
	...
	{
		WriteSortedJsonElement(writer, value, options);
	}

	private static void WriteSortedJsonElement(Utf8JsonWriter writer, JsonElement element, JsonSerializerOptions options)
	{
		switch (element.ValueKind)
		{
			...
			// Iterate over the array, writing its element objects
			case JsonValueKind.Array:
				writer.WriteStartArray();
				foreach (var item in element.EnumerateArray())
				{
					WriteSortedJsonElement(writer, item, options);
				}
				writer.WriteEndArray();
				break;

			default:
				// For other value kinds (string, number, bool, null), just write the value
...
public class SortedSnapshotConverter : JsonConverter<Dictionary<string, ContentFileSnapshot>>
{

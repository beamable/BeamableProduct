...
namespace Beamable.Api.Autogenerated
{
	public class OpenApiRegistration
	{
		public static void RegisterOpenApis(IDependencyBuilder builder)
		{
			...
			builder.AddOrOverrideScoped<IBeamBeamobundleApi, BeamBeamobundleApi>();
			builder.AddOrOverrideScoped<IBeamBeamoforcedbundleApi, BeamBeamoforcedbundleApi>();
			builder.AddOrOverrideScoped<IBeamCustomerApi, BeamCustomerApi>();
			builder.AddOrOverrideScoped<IBeamZonesApi, BeamZonesApi>();

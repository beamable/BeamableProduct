...
namespace Beamable.Api.Autogenerated.Models
{
	...
	{
		public ClientContentInfoJson[] items;
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
	...
	public partial class MicroserviceRegistrations : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public OptionalString routingKey = new OptionalString();
		public string serviceName;
		public OptionalLong startedByGamerTag = new OptionalLong();
		public OptionalBool trafficFilterEnabled = new OptionalBool();
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			...
			s.Serialize("serviceName", ref serviceName);
			if ((s.HasKey("startedByGamerTag")
						|| ((startedByGamerTag != default(OptionalLong))
						&& startedByGamerTag.HasValue)))
			{
				s.Serialize("startedByGamerTag", ref startedByGamerTag.Value);
				startedByGamerTag.HasValue = true;
			}
			if ((s.HasKey("trafficFilterEnabled")
						|| ((trafficFilterEnabled != default(OptionalBool))
						&& trafficFilterEnabled.HasValue)))

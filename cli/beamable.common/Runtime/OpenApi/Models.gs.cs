...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    [System.SerializableAttribute()]
    public partial class ApiPlayersPartyDeletePlayerPartyResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
        }
    ...
    public partial class SupportedFederation : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public OptionalOptionalJsonNodeWrapper settings = new OptionalOptionalJsonNodeWrapper();
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("settings") 
                        || ((settings != default(OptionalOptionalJsonNodeWrapper)) 
                        && settings.HasValue)))
            {
                s.Serialize("settings", ref settings.Value);
    ...
    [System.SerializableAttribute()]
    public class OptionalOptionalJsonNodeWrapper : Beamable.Common.Content.Optional<OptionalJsonNodeWrapper>
    {
        public OptionalOptionalJsonNodeWrapper()
        {
        }
        public OptionalOptionalJsonNodeWrapper(OptionalJsonNodeWrapper value)
        {
            HasValue = true;
            Value = value;
        }

...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    public class BeamoV2PlayerRuleOperationTypeExtensions
    {
        ...
        {
            if ((BeamoV2PlayerRuleOperationType.Contain == val))
            {
                return "Contain";
            }
            if ((BeamoV2PlayerRuleOperationType.NotContain == val))
            {
                return "NotContain";
            }
        ...
        public static BeamoV2PlayerRuleOperationType FromEnumString(string str)
        {
            if (("Contain" == str))
            {
                return BeamoV2PlayerRuleOperationType.Contain;
            }
            if (("NotContain" == str))
            {
                return BeamoV2PlayerRuleOperationType.NotContain;
            }
            if (("GreaterThan" == str))
            {
    ...
    public class BeamoV2PathRuleOperationTypeExtensions
    {
        public static string ToEnumString(BeamoV2PathRuleOperationType val)
        {
            ...
            if ((BeamoV2PathRuleOperationType.NotContain == val))
            {
                return "NotContain";
            }
        ...
        public static BeamoV2PathRuleOperationType FromEnumString(string str)
        {
            ...
            if (("NotContain" == str))
            {
                return BeamoV2PathRuleOperationType.NotContain;
            }
            if (("StartsWith" == str))
            {

...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    [System.SerializableAttribute()]
    public partial class CustomerActorHtmlResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString html = new OptionalString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("html") 
                        || ((html != default(OptionalString)) 
                        && html.HasValue)))
            {
                s.Serialize("html", ref html.Value);
                html.HasValue = true;
            }
        }
    }
    ...
    {
        public OptionalArrayOfServicePlanActorServicePlan result = new OptionalArrayOfServicePlanActorServicePlan();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("result") 
                        || ((result != default(OptionalArrayOfServicePlanActorServicePlan)) 
                        && result.HasValue)))
            {
                s.SerializeArray("result", ref result.Value);
    ...
    public partial class CreateServicePlanRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public string name;
        public OptionalArrayOfServicePlanActorRedisShardRequest redisShards = new OptionalArrayOfServicePlanActorRedisShardRequest();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("redisShards") 
                        || ((redisShards != default(OptionalArrayOfServicePlanActorRedisShardRequest)) 
    ...
    [System.SerializableAttribute()]
    public partial class ServicePlanActorRedisShardRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString masterHost = new OptionalString();
        public OptionalInt shardId = new OptionalInt();
        public OptionalString slaveHosts = new OptionalString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("slaveHosts") 
                        || ((slaveHosts != default(OptionalString)) 
                        && slaveHosts.HasValue)))
            {
                s.Serialize("slaveHosts", ref slaveHosts.Value);
    ...
    public partial class CreatePlanRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public RealmsBasicRedisShardRequest[] redisShards;
        public bool sharded;
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
    ...
    [System.SerializableAttribute()]
    public partial class RealmsBasicHtmlResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public string html;
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
    ...
    [System.SerializableAttribute()]
    public partial class RealmsBasicRedisShardRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
    ...
    [System.SerializableAttribute()]
    public class OptionalArrayOfServicePlanActorRedisShardRequest : Beamable.Common.Content.OptionalArray<ServicePlanActorRedisShardRequest>
    {
        public OptionalArrayOfServicePlanActorRedisShardRequest()
        {
        }
        public OptionalArrayOfServicePlanActorRedisShardRequest(ServicePlanActorRedisShardRequest[] value)
        {
            HasValue = true;
            Value = value;
        }

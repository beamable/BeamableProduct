...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    public class BeamoV2FederationTypeExtensions
    {
        public static string ToEnumString(BeamoV2FederationType val)
        {
            ...
            if ((BeamoV2FederationType.IFederatedPayments == val))
            {
                return "IFederatedPayments";
            }
            throw new System.ArgumentException("Unknown enum value");
        }
        public static BeamoV2FederationType FromEnumString(string str)
        {
            ...
            if (("IFederatedPayments" == str))
            {
                return BeamoV2FederationType.IFederatedPayments;
            }
            throw new System.ArgumentException("Unknown string value");
        }
    }
    ...
    [System.SerializableAttribute()]
    public partial class BeginPaymentRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public TransactionDetails details = new TransactionDetails();
        public OptionalString initHistoryData = new OptionalString();
        public string paymentProvider;
        public string playerId;
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            s.Serialize("details", ref details);
            if ((s.HasKey("initHistoryData") 
                        || ((initHistoryData != default(OptionalString)) 
                        && initHistoryData.HasValue)))
            {
                s.Serialize("initHistoryData", ref initHistoryData.Value);
                initHistoryData.HasValue = true;
            }
            s.Serialize("paymentProvider", ref paymentProvider);
            s.Serialize("playerId", ref playerId);
        }
    }
    [System.SerializableAttribute()]
    public partial class PaymentResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalLong transactionId = new OptionalLong();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("transactionId") 
                        || ((transactionId != default(OptionalLong)) 
                        && transactionId.HasValue)))
            {
                s.Serialize("transactionId", ref transactionId.Value);
                transactionId.HasValue = true;
            }
        }
    }
    [System.SerializableAttribute()]
    public partial class GetTransactionsResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalArrayOfTransaction transactions = new OptionalArrayOfTransaction();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("transactions") 
                        || ((transactions != default(OptionalArrayOfTransaction)) 
                        && transactions.HasValue)))
            {
                s.SerializeArray("transactions", ref transactions.Value);
                transactions.HasValue = true;
            }
        }
    }
    [System.SerializableAttribute()]
    public partial class Transaction : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public long beamableTransactionId;
        public OptionalDateTime created = new OptionalDateTime();
        public TransactionDetails details = new TransactionDetails();
        public OptionalArrayOfTransactionHistoryEntry history = new OptionalArrayOfTransactionHistoryEntry();
        public OptionalBool isInTerminalState = new OptionalBool();
        public long playerId;
        public string providerName;
        public OptionalString providerTransactionId = new OptionalString();
        public OptionalString replayGuard = new OptionalString();
        public OptionalString replayGuardValue = new OptionalString();
        public OptionalTransactionState state = new OptionalTransactionState();
        public OptionalDateTime updated = new OptionalDateTime();
        public OptionalString version = new OptionalString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            s.Serialize("beamableTransactionId", ref beamableTransactionId);
            if ((s.HasKey("created") 
                        || ((created != default(OptionalDateTime)) 
                        && created.HasValue)))
            {
            ...
            s.Serialize("details", ref details);
            if ((s.HasKey("history") 
                        || ((history != default(OptionalArrayOfTransactionHistoryEntry)) 
                        && history.HasValue)))
            {
                s.SerializeArray("history", ref history.Value);
                history.HasValue = true;
            }
            if ((s.HasKey("isInTerminalState") 
                        || ((isInTerminalState != default(OptionalBool)) 
                        && isInTerminalState.HasValue)))
            {
                s.Serialize("isInTerminalState", ref isInTerminalState.Value);
                isInTerminalState.HasValue = true;
            }
            s.Serialize("playerId", ref playerId);
            s.Serialize("providerName", ref providerName);
            if ((s.HasKey("providerTransactionId") 
                        || ((providerTransactionId != default(OptionalString)) 
                        && providerTransactionId.HasValue)))
            {
                s.Serialize("providerTransactionId", ref providerTransactionId.Value);
                providerTransactionId.HasValue = true;
            }
            if ((s.HasKey("replayGuard") 
                        || ((replayGuard != default(OptionalString)) 
                        && replayGuard.HasValue)))
            {
                s.Serialize("replayGuard", ref replayGuard.Value);
                replayGuard.HasValue = true;
            }
            ...
            if ((s.HasKey("state") 
                        || ((state != default(OptionalTransactionState)) 
                        && state.HasValue)))
            {
                s.SerializeEnum("state", ref state.Value, TransactionStateExtensions.ToEnumString, TransactionStateExtensions.FromEnumString);
                state.HasValue = true;
            }
            if ((s.HasKey("updated") 
                        || ((updated != default(OptionalDateTime)) 
    ...
    [System.SerializableAttribute()]
    public partial class CompletePaymentRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public string paymentProvider;
        public string playerId;
    ...
    [System.SerializableAttribute()]
    public partial class UpdatePaymentRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString reason = new OptionalString();
        public TransactionState state = new TransactionState();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("reason") 
                        || ((reason != default(OptionalString)) 
                        && reason.HasValue)))
            {
                s.Serialize("reason", ref reason.Value);
                reason.HasValue = true;
            }
            s.SerializeEnum("state", ref state, TransactionStateExtensions.ToEnumString, TransactionStateExtensions.FromEnumString);
        }
    }
    [System.SerializableAttribute()]
    public partial class VerifyReceiptRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString provider = new OptionalString();
        public OptionalString receipt = new OptionalString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("provider") 
                        || ((provider != default(OptionalString)) 
            ...
            if ((s.HasKey("receipt") 
                        || ((receipt != default(OptionalString)) 
                        && receipt.HasValue)))
            {
                s.Serialize("receipt", ref receipt.Value);
                receipt.HasValue = true;
            }
        }
    }
    [System.SerializableAttribute()]
    public partial class TransactionDetails : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString category = new OptionalString();
        public OptionalString gamePlace = new OptionalString();
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("gamePlace") 
                        || ((gamePlace != default(OptionalString)) 
                        && gamePlace.HasValue)))
            {
                s.Serialize("gamePlace", ref gamePlace.Value);
                gamePlace.HasValue = true;
            }
            ...
            s.Serialize("priceCents", ref priceCents);
            s.Serialize("productId", ref productId);
    ...
    public class TransactionStateExtensions
    {
        public static string ToEnumString(TransactionState val)
        {
            if ((TransactionState.STARTED == val))
            {
                return "STARTED";
            }
            if ((TransactionState.VERIFIED == val))
            {
                return "VERIFIED";
            }
            if ((TransactionState.PROVISIONED == val))
            {
                return "PROVISIONED";
            }
            if ((TransactionState.COMPLETED == val))
            {
                return "COMPLETED";
            }
            if ((TransactionState.CANCELLED == val))
            {
                return "CANCELLED";
            }
            if ((TransactionState.PENDING == val))
            {
                return "PENDING";
            }
            if ((TransactionState.FAILED == val))
            {
                return "FAILED";
            }
            if ((TransactionState.DISPUTED == val))
            {
                return "DISPUTED";
            }
            if ((TransactionState.RESOLVED == val))
            {
                return "RESOLVED";
            }
            if ((TransactionState.CLIENT_ISSUE == val))
            {
                return "CLIENT_ISSUE";
            }
            throw new System.ArgumentException("Unknown enum value");
        }
        public static TransactionState FromEnumString(string str)
        {
            if (("STARTED" == str))
            {
            ...
            if (("PROVISIONED" == str))
            {
                return TransactionState.PROVISIONED;
            }
            if (("COMPLETED" == str))
            {
            ...
            if (("RESOLVED" == str))
            {
                return TransactionState.RESOLVED;
            }
            if (("CLIENT_ISSUE" == str))
            {
                return TransactionState.CLIENT_ISSUE;
            }
            throw new System.ArgumentException("Unknown string value");
        }
    }
    [System.SerializableAttribute()]
    public partial class TransactionHistoryEntry : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public TransactionState change = new TransactionState();
        public OptionalString data = new OptionalString();
        public System.DateTime timestamp;
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            s.SerializeEnum("change", ref change, TransactionStateExtensions.ToEnumString, TransactionStateExtensions.FromEnumString);
            if ((s.HasKey("data") 
    ...
    [System.SerializableAttribute()]
    public class OptionalArrayOfTransaction : Beamable.Common.Content.OptionalArray<Transaction>
    {
        public OptionalArrayOfTransaction()
        {
        }
        public OptionalArrayOfTransaction(Transaction[] value)
        {
            HasValue = true;
            Value = value;
        }
    ...
    [System.SerializableAttribute()]
    public class OptionalTransactionState : Beamable.Common.Content.Optional<TransactionState>
    {
        public OptionalTransactionState()
        {
        }
        public OptionalTransactionState(TransactionState value)
        {
            HasValue = true;
            Value = value;
        }
    ...
    [System.SerializableAttribute()]
    public class OptionalArrayOfTransactionHistoryEntry : Beamable.Common.Content.OptionalArray<TransactionHistoryEntry>
    {
        public OptionalArrayOfTransactionHistoryEntry()
        {
        }
        public OptionalArrayOfTransactionHistoryEntry(TransactionHistoryEntry[] value)
        {
            HasValue = true;
            Value = value;
        }

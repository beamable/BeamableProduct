...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    public class ManifestFormatExtensions
    {
        public static string ToEnumString(ManifestFormat val)
        {
            if ((ManifestFormat.Csv == val))
            {
                return "csv";
            }
            if ((ManifestFormat.Json == val))
            {
                return "json";
            }
            throw new System.ArgumentException("Unknown enum value");
        }
        public static ManifestFormat FromEnumString(string str)
        {
            if (("csv" == str))
            {
    ...
    {
        public ManifestFormat format = new ManifestFormat();
        public OptionalString id = new OptionalString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            s.SerializeEnum("format", ref format, ManifestFormatExtensions.ToEnumString, ManifestFormatExtensions.FromEnumString);
            if ((s.HasKey("id") 
                        || ((id != default(OptionalString)) 
                        && id.HasValue)))
            {

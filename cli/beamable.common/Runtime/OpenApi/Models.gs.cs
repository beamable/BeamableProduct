...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    [System.SerializableAttribute()]
    public partial class JobActivityCursorPagedResult : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString nextCursor = new OptionalString();
        public OptionalArrayOfJobActivity records = new OptionalArrayOfJobActivity();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("nextCursor") 
                        || ((nextCursor != default(OptionalString)) 
            ...
            if ((s.HasKey("records") 
                        || ((records != default(OptionalArrayOfJobActivity)) 
                        && records.HasValue)))
            {
                s.SerializeArray("records", ref records.Value);
                records.HasValue = true;
    ...
    [System.SerializableAttribute()]
    public class OptionalArrayOfJobActivity : Beamable.Common.Content.OptionalArray<JobActivity>
    {
        public OptionalArrayOfJobActivity()
        {
        }
        public OptionalArrayOfJobActivity(JobActivity[] value)
        {
            HasValue = true;
            Value = value;
        }

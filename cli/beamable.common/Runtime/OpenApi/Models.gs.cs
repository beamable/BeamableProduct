...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    [System.SerializableAttribute()]
    public partial class BeamoV2LogSwitchContextDocument : Beamable.Serialization.JsonSerializable.ISerializable
    {
    ...
    public partial class BeamoV2ContextRuleFilter : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public OptionalMapOfString xCustom = new OptionalMapOfString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("paths") 
            ...
            if ((s.HasKey("x-custom") 
                        || ((xCustom != default(OptionalMapOfString)) 
                        && xCustom.HasValue)))
            {
                s.SerializeDictionary<MapOfString, string>("x-custom", ref xCustom.Value);
                xCustom.HasValue = true;
            }
        }
    }
    [System.SerializableAttribute()]
    ...
    {
        public OptionalInventoryFiltersDTO filters = new OptionalInventoryFiltersDTO();
        public OptionalArrayOfString scopes = new OptionalArrayOfString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("filters") 
                        || ((filters != default(OptionalInventoryFiltersDTO)) 
                        && filters.HasValue)))
            {
                s.Serialize("filters", ref filters.Value);
                filters.HasValue = true;
            }
            if ((s.HasKey("scopes") 
    ...
    public partial class InventoryFiltersDTO : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public OptionalArrayOfPropertyFilterDTO properties = new OptionalArrayOfPropertyFilterDTO();
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("properties") 
                        || ((properties != default(OptionalArrayOfPropertyFilterDTO)) 
                        && properties.HasValue)))
            {
                s.SerializeArray("properties", ref properties.Value);
                properties.HasValue = true;
    ...
    [System.SerializableAttribute()]
    public partial class SignupVerificationResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public AccountPlayerView account = new AccountPlayerView();
    ...
    public partial class CreateAccountWithCredsApiResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public OptionalString verification_required = new OptionalString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("account") 
            ...
            if ((s.HasKey("verification_required") 
                        || ((verification_required != default(OptionalString)) 
                        && verification_required.HasValue)))
            {
                s.Serialize("verification_required", ref verification_required.Value);
                verification_required.HasValue = true;
            }
        }
    }
    [System.SerializableAttribute()]
    ...
    [System.SerializableAttribute()]
    public partial class SignupVerificationRequest : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public string code;
        public string email;
        public string password;

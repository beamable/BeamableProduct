...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    {
        public BeamoV2LogContextRuleAuthor author = new BeamoV2LogContextRuleAuthor();
        public OptionalLong createdAt = new OptionalLong();
        public OptionalString description = new OptionalString();
        public bool enabled;
        public OptionalLong expiresAt = new OptionalLong();
        public BeamoV2ObjectId id = new BeamoV2ObjectId();
        ...
        public BeamoV2LogContextRuleAuthor whoLastEdit = new BeamoV2LogContextRuleAuthor();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            s.Serialize("author", ref author);
            if ((s.HasKey("createdAt") 
            ...
            s.Serialize("whoLastEdit", ref whoLastEdit);
        }
    }
    ...
    public partial class BeamoV2ContextRuleFilter : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public OptionalBeamoV2RuleOperationType pathsOperationType = new OptionalBeamoV2RuleOperationType();
        public OptionalBeamoV2RuleOperationType playerIdOperationType = new OptionalBeamoV2RuleOperationType();
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("pathsOperationType") 
                        || ((pathsOperationType != default(OptionalBeamoV2RuleOperationType)) 
                        && pathsOperationType.HasValue)))
            {
                s.SerializeEnum("pathsOperationType", ref pathsOperationType.Value, BeamoV2RuleOperationTypeExtensions.ToEnumString, BeamoV2RuleOperationTypeExtensions.FromEnumString);
                pathsOperationType.HasValue = true;
            }
            if ((s.HasKey("playerIdOperationType") 
                        || ((playerIdOperationType != default(OptionalBeamoV2RuleOperationType)) 
                        && playerIdOperationType.HasValue)))
            {
                s.SerializeEnum("playerIdOperationType", ref playerIdOperationType.Value, BeamoV2RuleOperationTypeExtensions.ToEnumString, BeamoV2RuleOperationTypeExtensions.FromEnumString);
    ...
    public enum BeamoV2RuleOperationType
    {
        Contain,
        NotContain,
    }
    public class BeamoV2RuleOperationTypeExtensions
    {
        public static string ToEnumString(BeamoV2RuleOperationType val)
        {
            if ((BeamoV2RuleOperationType.Contain == val))
            {
                return "Contain";
            }
            if ((BeamoV2RuleOperationType.NotContain == val))
            {
                return "NotContain";
            }
            throw new System.ArgumentException("Unknown enum value");
        }
        public static BeamoV2RuleOperationType FromEnumString(string str)
        {
            if (("Contain" == str))
            {
                return BeamoV2RuleOperationType.Contain;
            }
            if (("NotContain" == str))
            {
                return BeamoV2RuleOperationType.NotContain;
            }
            throw new System.ArgumentException("Unknown string value");
        }
    }
    ...
    [System.SerializableAttribute()]
    public class OptionalBeamoV2RuleOperationType : Beamable.Common.Content.Optional<BeamoV2RuleOperationType>
    {
        public OptionalBeamoV2RuleOperationType()
        {
        }
        public OptionalBeamoV2RuleOperationType(BeamoV2RuleOperationType value)
        {
            HasValue = true;
            Value = value;
        }

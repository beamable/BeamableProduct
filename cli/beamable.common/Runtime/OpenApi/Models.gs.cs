...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    [System.SerializableAttribute()]
    public partial class JobDefinitionCursorPagedResult : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString nextCursor = new OptionalString();
        public OptionalArrayOfJobDefinition records = new OptionalArrayOfJobDefinition();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("nextCursor") 
                        || ((nextCursor != default(OptionalString)) 
            ...
            if ((s.HasKey("records") 
                        || ((records != default(OptionalArrayOfJobDefinition)) 
                        && records.HasValue)))
            {
                s.SerializeArray("records", ref records.Value);
                records.HasValue = true;
    ...
    [System.SerializableAttribute()]
    public class OptionalArrayOfJobDefinition : Beamable.Common.Content.OptionalArray<JobDefinition>
    {
        public OptionalArrayOfJobDefinition()
        {
        }
        public OptionalArrayOfJobDefinition(JobDefinition[] value)
        {
            HasValue = true;
            Value = value;
        }

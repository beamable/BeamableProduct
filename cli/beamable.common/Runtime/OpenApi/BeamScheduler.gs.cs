...
namespace Beamable.Api.Autogenerated.Scheduler
{
    ...
    public partial interface IBeamSchedulerApi
    {
        ...
        /// </summary>
        /// <param name="limit">Maximum number of results. Cannot exceed 10000.</param>
        ...
        /// <param name="name">Optional name filter.</param>
        /// <param name="onlyUnique">When true, only returns unique jobs.</param>
        /// <param name="source">Optional source filter.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        ...
        /// </summary>
        /// <param name="cursor">Pagination cursor from a previous response. Mutually exclusive with from.</param>
        /// <param name="from">Return jobs suspended from this datetime. Mutually exclusive with cursor.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="JobDefinitionViewCursorPagedResult"/></returns>
        ...
        /// </summary>
        /// <param name="jobId">ID of the job to retrieve activity for.</param>
        /// <param name="limit">Maximum number of results. Cannot exceed 10000.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        ...
        /// </summary>
        /// <param name="from">Start time for the schedule preview. Defaults to now.</param>
        /// <param name="jobId">ID of the job to compute schedules for.</param>
        /// <param name="limit">Maximum number of executions to return. Cannot exceed 1000.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>

...
namespace Beamable.Api.Autogenerated.Customer
{
    ...
    public partial interface IBeamCustomerApi
    {
        ...
        /// </summary>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="CustomerActorHtmlResponse"/></returns>
        Promise<CustomerActorHtmlResponse> PutActivate([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
    ...
    public partial class BeamCustomerApi : IBeamCustomerApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="CustomerActorHtmlResponse"/></returns>
        public virtual Promise<CustomerActorHtmlResponse> PutActivate([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/api/customers/activate";
            // make the request and return the result
            return _requester.Request<CustomerActorHtmlResponse>(Method.PUT, gsUrl, default(object), includeAuthHeader, this.Serialize<CustomerActorHtmlResponse>);
        }
        /// <summary>
        /// GET call to `/api/customers/{customerId}` endpoint.
        /// </summary>

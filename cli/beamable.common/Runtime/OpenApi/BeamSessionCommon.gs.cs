...
namespace Beamable.Api.Autogenerated.Session
{
    ...
    public partial class BeamSessionApi : IBeamSessionApi
    {
        ...
        public BeamSessionApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

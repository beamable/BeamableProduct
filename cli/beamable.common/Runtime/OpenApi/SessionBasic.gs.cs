...
namespace Beamable.Api.Autogenerated.Session
{
    ...
    public partial interface ISessionApi
    {
        ...
        /// <param name="year"></param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="SessionBasicSessionClientHistoryResponse"/></returns>
        Promise<SessionBasicSessionClientHistoryResponse> GetClientHistory([System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<int> month, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<int> year, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        /// POST call to `/basic/session/` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="SessionBasicStartSessionRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="StartSessionResponse"/></returns>
        Promise<StartSessionResponse> Post(SessionBasicStartSessionRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
    }
    public partial class SessionApi : ISessionApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="SessionBasicSessionHistoryResponse"/></returns>
        public virtual Promise<SessionBasicSessionHistoryResponse> GetHistory(long dbid, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<int> month, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<int> year, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            ...
            // make the request and return the result
            return _requester.Request<SessionBasicSessionHistoryResponse>(Method.GET, gsUrl, default(object), includeAuthHeader, this.Serialize<SessionBasicSessionHistoryResponse>);
        }
        /// <summary>
        /// GET call to `/basic/session/status` endpoint.
        /// </summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="SessionBasicSessionClientHistoryResponse"/></returns>
        public virtual Promise<SessionBasicSessionClientHistoryResponse> GetClientHistory([System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<int> month, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<int> year, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            ...
            // make the request and return the result
            return _requester.Request<SessionBasicSessionClientHistoryResponse>(Method.GET, gsUrl, default(object), includeAuthHeader, this.Serialize<SessionBasicSessionClientHistoryResponse>);
        }
        /// <summary>
        /// POST call to `/basic/session/` endpoint.
        /// </summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="StartSessionResponse"/></returns>
        public virtual Promise<StartSessionResponse> Post(SessionBasicStartSessionRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {

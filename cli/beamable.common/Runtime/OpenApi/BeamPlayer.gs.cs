...
namespace Beamable.Api.Autogenerated.Player
{
    ...
    public partial interface IBeamPlayerApi
    {
        ...
        /// </summary>
        /// <param name="playerId">The player ID to heartbeat. Must match the authenticated player.</param>
        ...
        /// </summary>
        /// <param name="playerId">Player ID to retrieve online status for.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        ...
        /// </summary>
        /// <param name="playerId">The player ID to update. Must match the authenticated player.</param>

...
namespace Beamable.Api.Autogenerated.Datasetfile
{
    ...
    public partial class BeamDatasetfileApi : IBeamDatasetfileApi
    {
        ...
        public BeamDatasetfileApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

...
namespace Beamable.Api.Autogenerated.Beamo
{
    ...
    public partial interface IBeamoApi
    {
        ...
        /// </summary>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoBasicGetTemplatesResponse"/></returns>
        Promise<BeamoBasicGetTemplatesResponse> GetTemplates([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// </summary>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoBasicGetStatusResponse"/></returns>
        Promise<BeamoBasicGetStatusResponse> GetStatus([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// </summary>
        /// <param name="gsReq">The <see cref="BeamoBasicPostManifestRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PostManifestResponse"/></returns>
        Promise<PostManifestResponse> PostManifest(BeamoBasicPostManifestRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
    }
    public partial class BeamoApi : IBeamoApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoBasicGetTemplatesResponse"/></returns>
        public virtual Promise<BeamoBasicGetTemplatesResponse> GetTemplates([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/beamo/templates";
            // make the request and return the result
            return _requester.Request<BeamoBasicGetTemplatesResponse>(Method.GET, gsUrl, default(object), includeAuthHeader, this.Serialize<BeamoBasicGetTemplatesResponse>);
        }
        /// <summary>
        /// POST call to `/basic/beamo/queryLogs` endpoint.
        /// </summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoBasicGetStatusResponse"/></returns>
        public virtual Promise<BeamoBasicGetStatusResponse> GetStatus([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/beamo/status";
            // make the request and return the result
            return _requester.Request<BeamoBasicGetStatusResponse>(Method.GET, gsUrl, default(object), includeAuthHeader, this.Serialize<BeamoBasicGetStatusResponse>);
        }
        /// <summary>
        /// GET call to `/basic/beamo/manifest/current` endpoint.
        /// </summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PostManifestResponse"/></returns>
        public virtual Promise<PostManifestResponse> PostManifest(BeamoBasicPostManifestRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/beamo/manifest";
            // make the request and return the result

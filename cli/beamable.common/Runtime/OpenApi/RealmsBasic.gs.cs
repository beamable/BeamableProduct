...
namespace Beamable.Api.Autogenerated.Realms
{
    ...
    public partial interface IRealmsApi
    {
        ...
        /// <returns>A promise containing the <see cref="HtmlResponse"/></returns>
        Promise<HtmlResponse> GetCustomerActivate(long cid, string token, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
    ...
    public partial class RealmsApi : IRealmsApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="HtmlResponse"/></returns>
        public virtual Promise<HtmlResponse> GetCustomerActivate(long cid, string token, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/realms/customer/activate";
            string gsQuery = "?";
            System.Collections.Generic.List<string> gsQueries = new System.Collections.Generic.List<string>();
            gsQueries.Add(string.Concat("token=", _requester.EscapeURL(token.ToString())));
            gsQueries.Add(string.Concat("cid=", _requester.EscapeURL(cid.ToString())));
            ...
            return _requester.Request<HtmlResponse>(Method.GET, gsUrl, default(object), includeAuthHeader, this.Serialize<HtmlResponse>);
        }
        /// <param name="gsReq">The <see cref="CreateProjectRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="CommonResponse"/></returns>

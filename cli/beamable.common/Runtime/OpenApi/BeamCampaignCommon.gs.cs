...
namespace Beamable.Api.Autogenerated.Campaign
{
    ...
    public partial class BeamCampaignApi : IBeamCampaignApi
    {
        ...
        public BeamCampaignApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

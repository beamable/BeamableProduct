...
namespace Beamable.Api.Autogenerated.Stats
{
    ...
    public partial interface IStatsApi
    {
        ...
        /// </summary>
        /// <param name="gsReq">The <see cref="StatsBasicStatsSearchRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="StatsBasicStatsSearchResponse"/></returns>
        Promise<StatsBasicStatsSearchResponse> PostSearch(StatsBasicStatsSearchRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
    ...
    public partial class StatsApi : IStatsApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="StatsBasicStatsSearchResponse"/></returns>
        public virtual Promise<StatsBasicStatsSearchResponse> PostSearch(StatsBasicStatsSearchRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/stats/search";
            // make the request and return the result
            return _requester.Request<StatsBasicStatsSearchResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<StatsBasicStatsSearchResponse>);
        }
        /// <summary>
        /// POST call to `/basic/stats/search/extended` endpoint.
        /// </summary>

...
namespace Beamable.Api.Autogenerated.Models
{
	public static class LegacyConverterExtensions
	{
		...
		{
			return legacyServiceReference.Select(ConvertToBeamoV2).ToArray();
		}
		...
		{
			return legacyServiceComponents.Select(ConvertToBeamoV2).ToArray();
		}
		...
		{
			return legacyServiceDependencyReferences.Select(ConvertToBeamoV2).ToArray();
		}

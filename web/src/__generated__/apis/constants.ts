...
export const queryIdPlaceholder = "{queryId}";
...
export const ticketIdPlaceholder = "{ticketId}";
...
export const servicePlaceholder = "{service}";

export const executionIdPlaceholder = "{executionId}";

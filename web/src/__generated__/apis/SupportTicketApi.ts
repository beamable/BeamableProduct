 ...
 * 
 */
export async function customersPatchRealmsSupportTickets(requester: HttpRequester, customerId: string, realmId: string, ticketId: string, payload: any, gamertag?: string): Promise<HttpResponse<SupportTicket>> {
  let endpoint = "/api/customers/{customerId}/realms/{realmId}/support/tickets/{ticketId}".replace(customerIdPlaceholder, endpointEncoder(customerId)).replace(realmIdPlaceholder, endpointEncoder(realmId)).replace(ticketIdPlaceholder, endpointEncoder(ticketId));
 ...
 * 
 */
export async function customersDeleteRealmsSupportTickets(requester: HttpRequester, customerId: string, realmId: string, ticketId: string, gamertag?: string): Promise<HttpResponse<ApiCustomersRealmsSupportTicketsDeleteSupportTicketResponse>> {
  let endpoint = "/api/customers/{customerId}/realms/{realmId}/support/tickets/{ticketId}".replace(customerIdPlaceholder, endpointEncoder(customerId)).replace(realmIdPlaceholder, endpointEncoder(realmId)).replace(ticketIdPlaceholder, endpointEncoder(ticketId));

 ...
 * 
 */
export async function customersGetRealmsSecretsValuesByKey(requester: HttpRequester, customerId: string, key: string, realmId: string, gamertag?: string): Promise<HttpResponse<GetRealmSecretResponse>> {
 ...
 * 
 */
export async function customersPutRealmsSecretsValuesByKey(requester: HttpRequester, customerId: string, key: string, realmId: string, payload: PutRealmSecretRequest, gamertag?: string): Promise<HttpResponse<Acknowledge>> {
  let endpoint = "/api/customers/{customerId}/realms/{realmId}/secrets/values/{key}".replace(customerIdPlaceholder, endpointEncoder(customerId)).replace(keyPlaceholder, endpointEncoder(key)).replace(realmIdPlaceholder, endpointEncoder(realmId));
 ...
 * 
 */
export async function customersDeleteRealmsSecretsValuesByKey(requester: HttpRequester, customerId: string, key: string, realmId: string, gamertag?: string): Promise<HttpResponse<Acknowledge>> {
  let endpoint = "/api/customers/{customerId}/realms/{realmId}/secrets/values/{key}".replace(customerIdPlaceholder, endpointEncoder(customerId)).replace(keyPlaceholder, endpointEncoder(key)).replace(realmIdPlaceholder, endpointEncoder(realmId));

 ...
 * 
 */
export async function playersGetSupportTicketsByTicketId(requester: HttpRequester, playerId: string, ticketId: string, gamertag?: string): Promise<HttpResponse<PlayerSupportTicketView>> {

 ...
 * 
 */
export async function beamoGetBundlesByBundleNameAndNs(requester: HttpRequester, bundleName: string, ns: string, gamertag?: string): Promise<HttpResponse<GetBundleResponse>> {

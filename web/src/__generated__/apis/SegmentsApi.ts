 ...
 * 
 */
export async function customersGetRealmsSegmentsMembersByCustomerIdAndPlayerIdAndRealmIdAndSegmentId(requester: HttpRequester, customerId: string, playerId: bigint | string, realmId: string, segmentId: string, gamertag?: string): Promise<HttpResponse<MembershipCheckResponse>> {

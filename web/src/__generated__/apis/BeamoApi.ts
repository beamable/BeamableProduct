...
import { BeamoV2ApiBeamoServicesLogsQueryDeleteBeamoResponse } from '@/__generated__/schemas/BeamoV2ApiBeamoServicesLogsQueryDeleteBeamoResponse';
import { BeamoV2ConnectionStringResponse } from '@/__generated__/schemas/BeamoV2ConnectionStringResponse';
import { BeamoV2DeleteRegistrationRequest } from '@/__generated__/schemas/BeamoV2DeleteRegistrationRequest';
import { BeamoV2EmptyMessage } from '@/__generated__/schemas/BeamoV2EmptyMessage';
import { BeamoV2FederationRegistrationResponse } from '@/__generated__/schemas/BeamoV2FederationRegistrationResponse';
import { BeamoV2GetManifestsResponse } from '@/__generated__/schemas/BeamoV2GetManifestsResponse';
import { BeamoV2GetMetricsRequest } from '@/__generated__/schemas/BeamoV2GetMetricsRequest';
import { BeamoV2GetServiceSecretResponse } from '@/__generated__/schemas/BeamoV2GetServiceSecretResponse';
import { BeamoV2GetStatusResponse } from '@/__generated__/schemas/BeamoV2GetStatusResponse';
import { BeamoV2GetTemplatesResponse } from '@/__generated__/schemas/BeamoV2GetTemplatesResponse';
import { BeamoV2Manifest } from '@/__generated__/schemas/BeamoV2Manifest';
import { BeamoV2ManifestChecksum } from '@/__generated__/schemas/BeamoV2ManifestChecksum';
import { BeamoV2PostManifestRequest } from '@/__generated__/schemas/BeamoV2PostManifestRequest';
import { BeamoV2PromoteBeamoManifestRequest } from '@/__generated__/schemas/BeamoV2PromoteBeamoManifestRequest';
import { BeamoV2QueryResponse } from '@/__generated__/schemas/BeamoV2QueryResponse';
import { BeamoV2ServiceRegistrationQuery } from '@/__generated__/schemas/BeamoV2ServiceRegistrationQuery';
import { BeamoV2ServiceRegistrationRequest } from '@/__generated__/schemas/BeamoV2ServiceRegistrationRequest';
import { BeamoV2ServiceRegistrationResponse } from '@/__generated__/schemas/BeamoV2ServiceRegistrationResponse';
import { BeamoV2SignedRequest } from '@/__generated__/schemas/BeamoV2SignedRequest';
import { BeamoV2StartServiceLogsRequest } from '@/__generated__/schemas/BeamoV2StartServiceLogsRequest';
import { BeamoV2StoragePerformance } from '@/__generated__/schemas/BeamoV2StoragePerformance';
import { BeamoV2UriResponse } from '@/__generated__/schemas/BeamoV2UriResponse';

 ...
 *
 * @interface FetchRequesterConfig
 */
export interface FetchRequesterConfig {
  /**
   ...
   * `Authorization` header of each request. Can return a string directly
   * or a Promise resolving to a string.
   */

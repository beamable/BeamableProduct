...
`beam-native-mobile/Unity/Plugins/Android/beamable-notifications-release.aar` (the shared
...
`beam-native-mobile/Unity/`, same API as iOS) — they do **not** call the facade directly.

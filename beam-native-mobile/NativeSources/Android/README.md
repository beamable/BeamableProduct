...
```
beam-native-mobile/NativeSources/Android/BeamableNotifications/   (Gradle project; module: notifications)
...
`beam-native-mobile/Unity/Plugins/Android/beamable-notifications-release.aar`.
...
(`beam-native-mobile/Unity/Samples~/NativeDemo/`).

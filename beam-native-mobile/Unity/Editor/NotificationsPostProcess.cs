...
namespace Beamable.Notifications.Editor
{
    /// <summary>
    ...
    public static class NotificationsPostProcess
    {
        ...
        private const string AppGroupId = "group.com.beamable.notifications";
        ...
        private static string ResolveExtensionSourceDir()
        {
            ...
            string packageRoot = Path.GetFullPath("Packages/com.beamable.notifications");

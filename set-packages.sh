...
PACKAGES_TO_SET_ARR=($PKG_COMMON, $PKG_SERVER_COMMON, $PKG_MICROSERVICE_TOOLING_COMMON, $PKG_MICROSERVICE_UNITY_ENGINE_STUBS, $PKG_MICROSERVICE_UNITY_ENGINE_STUBS_ADDRESSABLES, $PKG_CLI, $PKG_MICROSERVICE, $PKG_TEMPLATES)

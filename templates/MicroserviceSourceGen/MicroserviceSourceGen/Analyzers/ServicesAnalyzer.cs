...
public class ServicesAnalyzer : DiagnosticAnalyzer
{
	...
	public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
		ImmutableArray.Create(Diagnostics.Srv.InvalidAsyncVoidCallableMethod,
			...
			Diagnostics.Srv.CallableMethodTypeInsideMicroserviceScope);
	...
	private static void ValidateMethodReturnAndParametersType(SyntaxNodeAnalysisContext context)
	{
		var method = (MethodDeclarationSyntax)context.Node;
		IMethodSymbol methodSymbol = context.SemanticModel.GetDeclaredSymbol(method);
	...
	private static void ValidateReturnType(SyntaxNodeAnalysisContext context, IMethodSymbol methodSymbol,
	...
	private static void ValidateParameters(SyntaxNodeAnalysisContext context, IMethodSymbol methodSymbol)
	{
		...
		{
			ValidateTypeAssembly(context, parameterSymbol.Locations.FirstOrDefault(), parameterSymbol.Type, methodAssembly,
				methodSymbol.Name);
		}
	...
	private static void ValidateTypeAssembly(SyntaxNodeAnalysisContext context, Location location, ITypeSymbol typeSymbol, IAssemblySymbol methodAssemblySymbol, string methodName)
	{
		...
		if (methodAssemblySymbol.Identity == returnAssemblySymbol.Identity)
		{
			...
			var diagnostic = Diagnostic.Create(Diagnostics.Srv.CallableMethodTypeInsideMicroserviceScope,

...
public static class Diagnostics
{
	...
	{
		//public const string DECLARED_FEDERATION_MISSING_FROM_SOURCE_GEN_CONFIG_DIAGNOSTIC_ID = "BEAM_FED_O001"; This isn't being used anymore, but we kept it here to keep the Diagnostics IDs order.
		//public const string CONFIGURED_FEDERATION_MISSING_FROM_CODE_DIAGNOSTIC_ID = "BEAM_FED_O002"; This isn't being used anymore, but we kept it here to keep the Diagnostics IDs order.
		...
		//public const string FEDERATION_CONFIG_FILE_NOT_FOUND_ID = "BEAM_FED_O007"; This isn't being used anymore, but we kept it here to keep the Diagnostics IDs order.
		//public const string ERROR_PARSING_FEDERATION_CONFIG_FILE_ID = "BEAM_FED_O008"; This isn't being used anymore, but we kept it here to keep the Diagnostics IDs order.
		//public const string FEDERATION_ID_INVALID_CONFIG_FILE_ID = "BEAM_FED_O009"; This isn't being used anymore, but we kept it here to keep the Diagnostics IDs order.

...
";
	...
	/// <summary>
	/// A payments federation must analyze cleanly. Federation discovery is reflection-driven, so a new
	/// interface is picked up without analyzer changes — this pins that, so a later special-case in the
	/// analyzer cannot quietly start rejecting payments.
	/// </summary>
	[Fact]
	public async Task Test_Diagnostic_Fed_PaymentsFederationIsAccepted()
	{
		const string UserCode = @"
using System.Collections.Generic;
using Beamable.Api.Autogenerated.Models;
...
[FederationId(""my_store"")]
public class MyStore : IFederationId {
}

[Microservice(""some_user_service"")]
public partial class SomeUserMicroservice : Microservice, IFederatedPayments<MyStore>
{
    public Promise<FederatedBeginPaymentResponse> BeginPayment(string playerId, FederatedPaymentDetails details)
    {
        throw new System.NotImplementedException();
    }

    public Promise<FederatedVerifyPaymentsResponse> VerifyPayments(string playerId, List<long> transactionIds, string receipt)
    {
        throw new System.NotImplementedException();
    }

    public Promise<bool> VerifyReceipt(string receipt)
    {
        throw new System.NotImplementedException();
    }

    public Promise<FederatedFulfillPaymentResponse> FulfillPayment(string playerId, long transactionId, string goods)
    {
        throw new System.NotImplementedException();
    }
}
";
		...
		ctx.ExpectedDiagnostics.Add(
			new DiagnosticResult(Diagnostics.Fed.FederationCodeGeneratedProperly));

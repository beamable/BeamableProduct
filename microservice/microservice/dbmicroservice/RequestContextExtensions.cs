...
namespace Beamable.Server
{
	public static class RequestContextExtensions
	{
			...
			out RequestContext context)
		{
			...
			var microserviceRequestContext =
				new MicroserviceRequestContext(args.CustomerID, args.ProjectName, id, status, userID, path, methodName,
					body, scopes, null) { BodyElement = bodyElement, HeaderElement = headerElement };

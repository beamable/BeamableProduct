...
namespace DefaultNamespace
{
   public class SampleUsage : MonoBehaviour
   {
      ...
      void Start()
      {
	      ...
	      beamable.Inventory.Currencies.OnLoadingFinished += () => Debug.Log("Loading currency finished");
	      beamable.Inventory.Currencies.OnLoadingStarted += () => Debug.Log("Loading currency started");
	      beamable.Inventory.Currencies.OnUpdated += Print;
	      beamable.Inventory.Currencies.OnDataUpdated += currencies =>
      ...
      private void Update()
      {
	      var currencyMessages = string.Join(
		      "\n",
		      beamable.Inventory.Currencies.Select(
      ...
      void Print()
      {
         ...
         Debug.Log($"user=[{beamable.PlayerId}] Printing {beamable.Inventory.Currencies.Count} Currencies");
         foreach (var currency in beamable.Inventory.Currencies)
         {

...
public class HttpCallBuilderWrapper
{
	...
	public ISchedulerBuilderTrigger Run<T>(Method method, string uri, T body, Dictionary<string, string> headers=null)
	{
	...
	public ISchedulerBuilderTrigger Run(Method method, string uri, string contentType="application/json", Dictionary<string, string> headers=null)
	{
	...
	public ISchedulerBuilderTrigger Run(Method method, string uri, string body, string contentType="application/json", Dictionary<string, string> headers=null)
	{

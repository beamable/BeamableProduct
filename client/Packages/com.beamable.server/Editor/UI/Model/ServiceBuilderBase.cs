...
namespace Beamable.Editor.UI.Model
{
	public abstract class ServiceBuilderBase : IBeamableBuilder
	{
		...
		public Action<int, int> OnBuildingProgress
		{
			get;
			set;
		}

		public Action<int, int> OnStartingProgress
		{
			get;
			set;
		}

		public Action<bool> OnBuildingFinished
		{
			get;
			set;
		}

		public Action<bool> OnStartingFinished
		{
			get;
			set;
		}

...
{
	public class MigrationConfirmationVisualElement : ContentManagerComponent
	{
		...
		public MigrationConfirmationVisualElement() : base(nameof(MigrationConfirmationVisualElement))
		{
		}

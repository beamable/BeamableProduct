...
namespace Beamable.Editor.Microservice.UI.Components
{
	public class DependentServicesMicroserviceEntryVisualElement : MicroserviceComponent
	{
		...
		public MicroserviceModel Model
		{
			get;
			set;
		}

		public List<DependentServicesCheckboxVisualElement> DependentServices
		{
			get;
			private set;
		}

		public Label MicroserviceName
		{
			get;
			private set;
		}
		...
		public DependentServicesMicroserviceEntryVisualElement(IEnumerable<MongoStorageModel> dependentServices) : base(
			nameof(DependentServicesMicroserviceEntryVisualElement))
		{
		...
		private void UpdateVisualElements()
		{
			...
			DependentServices =
				new List<DependentServicesCheckboxVisualElement>(MicroservicesDataModel.Instance.Storages.Count);
			...
			foreach (var storageObjectModel in MicroservicesDataModel.Instance.Storages)
			{
				...
				var newElement =
					new DependentServicesCheckboxVisualElement(isRelation) { MongoStorageModel = storageObjectModel };
		...
		public void SetEmptyEntries()
		{
			...
			{
				var newElement =
					new DependentServicesCheckboxVisualElement(false) { MongoStorageModel = storageObjectModel };
				newElement.Refresh();

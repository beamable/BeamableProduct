		...
		public void CreateCommonArea()
		{
			...
			try
			{
				...
				if (asset == null)
				{
					...
					var originalText = File.ReadAllText(Path.Combine("Packages/com.beamable.server/Template", "SharedSample.cs"));
		...
		public void CreateAutoGeneratedServicesArea()
		{
			...
			try
			{
				...
				if (asset == null)
				{
					...
					// make sure there is at least 1 script in that folder. Otherwise; we'll get a warning from Unity saying it won't compile it.
					var originalText = File.ReadAllText(Path.Combine("Packages/com.beamable.server/Template", "AutoGenMicroserviceClientSample.cs"));

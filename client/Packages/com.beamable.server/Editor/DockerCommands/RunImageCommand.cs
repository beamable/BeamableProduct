...
namespace Beamable.Server.Editor.DockerCommands
{
	...
	public class RunStorageToolCommand : RunImageCommand
	{
		...
		{
			"AuthenticationFailed", "UnhandledPromiseRejectionWarning", "process with a non-zero exit code"
		};
	...
	public class RunImageCommand : DockerCommand
	{
		...
		public Dictionary<uint, uint> Ports
		{
			get;
			protected set;
		}

		public Dictionary<string, string> NamedVolumes
		{
			get;
			protected set;
		}

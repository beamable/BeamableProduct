...
namespace Beamable.Server.Editor
{
	...
	public class MicroserviceStateMachine
	{
		...
		public MicroserviceState CurrentState
		{
			get;
			private set;
		}
										...
										MicroserviceState initialState = MicroserviceState.IDLE)
		{
			...
			{
				{
					new MicroserviceTransition(MicroserviceState.IDLE, MicroserviceCommand.BUILD),
					MicroserviceState.BUILDING
				},
				{
					new MicroserviceTransition(MicroserviceState.BUILDING, MicroserviceCommand.COMPLETE),
					MicroserviceState.IDLE
				},
				{
					new MicroserviceTransition(MicroserviceState.IDLE, MicroserviceCommand.COMPLETE),
					MicroserviceState.IDLE
				},
				{
					new MicroserviceTransition(MicroserviceState.IDLE, MicroserviceCommand.START),
					MicroserviceState.RUNNING
				},
				{
					new MicroserviceTransition(MicroserviceState.RUNNING, MicroserviceCommand.STOP),
					MicroserviceState.STOPPING
				},
				{
					new MicroserviceTransition(MicroserviceState.RUNNING, MicroserviceCommand.COMPLETE),
					MicroserviceState.IDLE
				},
				{
					new MicroserviceTransition(MicroserviceState.STOPPING, MicroserviceCommand.COMPLETE),
					MicroserviceState.IDLE
				},
			};
		}

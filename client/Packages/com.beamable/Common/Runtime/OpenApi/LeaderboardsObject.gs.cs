...
namespace Beamable.Api.Autogenerated.Leaderboards
{
	...
	{
		/// <param name="objectId">Gamertag of the player. Underlying objectId type is string.</param>
		...
		Promise<LeaderboardMembershipResponse> ObjectGetMembership(long playerId, string objectId);
		...
		Promise<LeaderboardPartitionInfo> ObjectGetPartition(long playerId, string objectId);
		/// <param name="objectId">Gamertag of the player. Underlying objectId type is string.</param>
		/// <returns>A promise containing the <see cref="LeaderBoardViewResponse"/></returns>
		...
		Promise<MatchMakingMatchesPvpResponse> ObjectGetMatches(int poolSize, int windows, int windowSize, string objectId, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)][System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
		/// <param name="objectId">Gamertag of the player. Underlying objectId type is string.</param>
	...
	public partial class LeaderboardsApi : ILeaderboardsApi
	{
		...
		/// <param name="objectId">Gamertag of the player. Underlying objectId type is string.</param>
		/// <returns>A promise containing the <see cref="LeaderboardMembershipResponse"/></returns>
		public virtual Promise<LeaderboardMembershipResponse> ObjectGetMembership(long playerId, string objectId)
		{
		...
		/// <param name="objectId">Gamertag of the player. Underlying objectId type is string.</param>
		/// <returns>A promise containing the <see cref="LeaderboardPartitionInfo"/></returns>
		public virtual Promise<LeaderboardPartitionInfo> ObjectGetPartition(long playerId, string objectId)
		{
		...
		/// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
		/// <returns>A promise containing the <see cref="MatchMakingMatchesPvpResponse"/></returns>
		public virtual Promise<MatchMakingMatchesPvpResponse> ObjectGetMatches(int poolSize, int windows, int windowSize, string objectId, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)][System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
		{

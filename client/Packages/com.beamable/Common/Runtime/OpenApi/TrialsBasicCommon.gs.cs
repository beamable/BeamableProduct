<<<<<<<< HEAD:client/Packages/com.beamable/Common/Runtime/OpenApi/Chatv2ObjectCommon.gs.cs
...
namespace Beamable.Api.Autogenerated.Chatv2
{
	...
	public partial class Chatv2Api : IChatv2Api
	{
		...
		public Chatv2Api(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))][System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
		{
...
namespace Beamable.Api.Autogenerated.Trials
{
	...
	public partial class TrialsApi : ITrialsApi
	{
		...
		private IDependencyProvider _provider;
		private System.Collections.Generic.List<Beamable.Serialization.JsonSerializable.ISerializableFactory> _serializationFactories;
		public TrialsApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))][System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
		{
			this._requester = requester;
			_provider = provider;
			_serializationFactories = new System.Collections.Generic.List<Beamable.Serialization.JsonSerializable.ISerializableFactory>();
...
>>>>>>>> origin/main:client/Packages/com.beamable/Common/Runtime/OpenApi/TrialsBasicCommon.gs.cs

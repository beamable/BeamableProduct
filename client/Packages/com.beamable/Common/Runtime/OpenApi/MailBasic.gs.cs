...
namespace Beamable.Api.Autogenerated.Mail
{
	...
	public partial interface IMailApi
	{
		...
		/// <param name="gsReq">The <see cref="MailBasicBulkSendMailRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="MailSuccessResponse"/></returns>
		Promise<MailSuccessResponse> PostBulk(MailBasicBulkSendMailRequest gsReq);
	}
	public partial class MailApi : IMailApi
	{
		...
		/// <param name="gsReq">The <see cref="MailBasicBulkSendMailRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="MailSuccessResponse"/></returns>
		public virtual Promise<MailSuccessResponse> PostBulk(MailBasicBulkSendMailRequest gsReq)
		{

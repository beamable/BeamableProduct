...
namespace Beamable.Api.Autogenerated.Customer
{
    ...
    public partial class BeamCustomerApi : IBeamCustomerApi
    {
        ...
        public BeamCustomerApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

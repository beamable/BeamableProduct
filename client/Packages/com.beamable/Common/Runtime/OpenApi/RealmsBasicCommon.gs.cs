...
namespace Beamable.Api.Autogenerated.Realms
{
    ...
    public partial class RealmsApi : IRealmsApi
    {
        ...
        public RealmsApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

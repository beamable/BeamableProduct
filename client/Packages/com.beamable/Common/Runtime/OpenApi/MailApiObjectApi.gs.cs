...
namespace Beamable.Api.Open.Mail
{
    ...
    public interface IMailApiObjectApi
    {
        Promise<MailResponse> GetDetail(long mid, string objectId, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        Promise<ListMailCategoriesResponse> GetCategories(string objectId, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        Promise<MailSearchResponse> PostSearch(string objectId, MailSearchRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        Promise<MailSuccessResponse> PostBulk(string objectId, BulkSendMailRequest gsReq);
        Promise<MailSuccessResponse> PutBulk(string objectId, BulkUpdateMailObjectRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        Promise<MailSuccessResponse> PutAcceptMany(string objectId, AcceptMultipleAttachments gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        Promise<MailQueryResponse> Get(string objectId, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        Promise<SendMailResponse> Post(string objectId, SendMailObjectRequest gsReq);
        Promise<MailSuccessResponse> Put(string objectId, UpdateMailRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
    }
    public class MailApiObjectApi : IMailApiObjectApi
    {

...
namespace Beamable.Api.Autogenerated.Tournaments
{
    ...
    public partial class TournamentsApi : ITournamentsApi
    {
        ...
        public TournamentsApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

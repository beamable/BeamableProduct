...
namespace Beamable.Api.Autogenerated.Mail
{
    ...
    {
        /// <summary>
        /// GET call to `/object/mail/{objectId}/detail` endpoint.
        /// </summary>
        ...
        /// <summary>
        /// GET call to `/object/mail/{objectId}/categories` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        ...
        /// <summary>
        /// POST call to `/object/mail/{objectId}/search` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        ...
        /// <summary>
        /// POST call to `/object/mail/{objectId}/bulk` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        ...
        Promise<MailSuccessResponse> ObjectPostBulk(long objectId, BulkSendMailRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        /// PUT call to `/object/mail/{objectId}/bulk` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        ...
        /// <summary>
        /// PUT call to `/object/mail/{objectId}/accept/many` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        ...
        /// <summary>
        /// GET call to `/object/mail/{objectId}/` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        ...
        /// <summary>
        /// POST call to `/object/mail/{objectId}/` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        ...
        Promise<SendMailResponse> ObjectPost(long objectId, SendMailObjectRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        /// PUT call to `/object/mail/{objectId}/` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
    ...
    public partial class MailApi : IMailApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="MailSuccessResponse"/></returns>
        public virtual Promise<MailSuccessResponse> ObjectPostBulk(long objectId, BulkSendMailRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="SendMailResponse"/></returns>
        public virtual Promise<SendMailResponse> ObjectPost(long objectId, SendMailObjectRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/object/mail/{objectId}/";
            gsUrl = gsUrl.Replace("{objectId}", _requester.EscapeURL(objectId.ToString()));
            // make the request and return the result
            return _requester.Request<SendMailResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<SendMailResponse>);
        }
        /// <summary>
        /// PUT call to `/object/mail/{objectId}/` endpoint.
        /// </summary>

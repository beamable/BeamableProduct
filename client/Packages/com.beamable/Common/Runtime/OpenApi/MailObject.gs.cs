...
namespace Beamable.Api.Autogenerated.Mail
{
	...
	public partial interface IMailApi
	{
		...
		/// <param name="objectId">Gamertag of the player. Underlying objectId type is integer in format int64.</param>
		/// <param name="gsReq">The <see cref="MailObjectBulkSendMailRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="MailSuccessResponse"/></returns>
		Promise<MailSuccessResponse> ObjectPostBulk(long objectId, MailObjectBulkSendMailRequest gsReq);
		/// <param name="objectId">Gamertag of the player. Underlying objectId type is integer in format int64.</param>
	...
	public partial class MailApi : IMailApi
	{
		...
		/// <param name="gsReq">The <see cref="MailObjectBulkSendMailRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="MailSuccessResponse"/></returns>
		public virtual Promise<MailSuccessResponse> ObjectPostBulk(long objectId, MailObjectBulkSendMailRequest gsReq)
		{

...
namespace Beamable.Api.Open.Accounts
{
    ...
    public interface IAccountsApiBasicApi
    {
        ...
        Promise<AccountSearchResponse> GetSearch(string query, int page, int pagesize);
    ...
    public class AccountsApiBasicApi : IAccountsApiBasicApi
    {

...
namespace Beamable.Api.Autogenerated.Leaderboards
{
    ...
    public partial class LeaderboardsApi : ILeaderboardsApi
    {
        ...
        public LeaderboardsApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

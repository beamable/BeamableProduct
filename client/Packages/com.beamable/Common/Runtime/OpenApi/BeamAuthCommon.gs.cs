...
namespace Beamable.Api.Autogenerated.Auth
{
    ...
    public partial class BeamAuthApi : IBeamAuthApi
    {
        ...
        public BeamAuthApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

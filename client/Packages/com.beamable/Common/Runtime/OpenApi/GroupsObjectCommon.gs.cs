...
namespace Beamable.Api.Autogenerated.Groups
{
    ...
    public partial class GroupsApi : IGroupsApi
    {
        ...
        public GroupsApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

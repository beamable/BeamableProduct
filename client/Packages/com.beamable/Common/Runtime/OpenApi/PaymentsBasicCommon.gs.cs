...
namespace Beamable.Api.Autogenerated.Payments
{
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        public PaymentsApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

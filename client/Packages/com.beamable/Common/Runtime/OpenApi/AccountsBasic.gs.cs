...
namespace Beamable.Api.Autogenerated.Accounts
{
	...
	public partial interface IAccountsApi
	{
		...
		/// <param name="gsReq">The <see cref="ExternalIdentityRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="AttachExternalIdentityApiResponse"/></returns>
		Promise<AttachExternalIdentityApiResponse> PostExternal_identity(ExternalIdentityRequest gsReq);
	...
	public partial class AccountsApi : IAccountsApi
	{
		...
		/// <param name="gsReq">The <see cref="ExternalIdentityRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="AttachExternalIdentityApiResponse"/></returns>
		public virtual Promise<AttachExternalIdentityApiResponse> PostExternal_identity(ExternalIdentityRequest gsReq)
		{

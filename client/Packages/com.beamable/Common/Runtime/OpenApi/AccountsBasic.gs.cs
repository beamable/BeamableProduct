...
namespace Beamable.Api.Autogenerated.Accounts
{
	...
	public partial interface IAccountsApi
	{
		...
		Promise<AccountPortalView> PostAdminAdminUser(AddAccountRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)][System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
	...
	public partial class AccountsApi : IAccountsApi
	{
		...
		/// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
		/// <returns>A promise containing the <see cref="AccountPortalView"/></returns>
		public virtual Promise<AccountPortalView> PostAdminAdminUser(AddAccountRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)][System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
		{

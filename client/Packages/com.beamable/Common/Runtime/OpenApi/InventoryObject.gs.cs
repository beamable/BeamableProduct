...
namespace Beamable.Api.Autogenerated.Inventory
{
    ...
    public partial interface IInventoryApi
    {
        ...
        Promise<InventoryUpdateResponse> ObjectPut(long objectId, InventoryUpdateRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
    ...
    public partial class InventoryApi : IInventoryApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="InventoryUpdateResponse"/></returns>
        public virtual Promise<InventoryUpdateResponse> ObjectPut(long objectId, InventoryUpdateRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/object/inventory/{objectId}/";
            gsUrl = gsUrl.Replace("{objectId}", _requester.EscapeURL(objectId.ToString()));
            // make the request and return the result
            return _requester.Request<InventoryUpdateResponse>(Method.PUT, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<InventoryUpdateResponse>);
        }
        /// <summary>
        /// PUT call to `/object/inventory/{objectId}/proxy/reload` endpoint.
        /// </summary>

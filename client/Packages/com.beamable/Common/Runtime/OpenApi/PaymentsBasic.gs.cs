...
namespace Beamable.Api.Autogenerated.Payments
{
    ...
    public partial interface IPaymentsApi
    {
        ...
        /// <summary>
        /// POST call to `/basic/payments/stripe/purchase/cancel` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="CancelPurchaseRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        Promise<PaymentResultResponse> PostStripePurchaseCancel(CancelPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// <summary>
        /// POST call to `/basic/payments/stripe/purchase/complete` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="CompletePurchaseRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        Promise<PaymentResultResponse> PostStripePurchaseComplete(CompletePurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// <summary>
        /// POST call to `/basic/payments/stripe/webhook/setup` endpoint.
        /// </summary>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="StripeWebhookSetupResponse"/></returns>
        Promise<StripeWebhookSetupResponse> PostStripeWebhookSetup([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// <summary>
        /// GET call to `/basic/payments/stripe/product` endpoint.
        /// </summary>
        /// <param name="sku"></param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="GetProductResponse"/></returns>
        Promise<GetProductResponse> GetStripeProduct(string sku, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        /// POST call to `/basic/payments/stripe/purchase/verify` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="VerifyPurchaseRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        Promise<PaymentResultResponse> PostStripePurchaseVerify(VerifyPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// <summary>
        /// POST call to `/basic/payments/stripe/purchase/fail` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="FailPurchaseRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        Promise<PaymentResultResponse> PostStripePurchaseFail(FailPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// <summary>
        /// POST call to `/basic/payments/stripe/purchase/begin` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="BeginPurchaseRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeginPurchaseResponse"/></returns>
        Promise<BeginPurchaseResponse> PostStripePurchaseBegin(BeginPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// <summary>
        /// POST call to `/basic/payments/stripe/purchase/track` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="TrackPurchaseRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        Promise<PaymentResultResponse> PostStripePurchaseTrack(TrackPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        public virtual Promise<PaymentResultResponse> PostStripePurchaseCancel(CancelPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/payments/stripe/purchase/cancel";
            // make the request and return the result
            return _requester.Request<PaymentResultResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<PaymentResultResponse>);
        }
        /// <summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        public virtual Promise<PaymentResultResponse> PostStripePurchaseComplete(CompletePurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/payments/stripe/purchase/complete";
            // make the request and return the result
            return _requester.Request<PaymentResultResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<PaymentResultResponse>);
        }
        /// <summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="StripeWebhookSetupResponse"/></returns>
        public virtual Promise<StripeWebhookSetupResponse> PostStripeWebhookSetup([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/payments/stripe/webhook/setup";
            // make the request and return the result
            return _requester.Request<StripeWebhookSetupResponse>(Method.POST, gsUrl, default(object), includeAuthHeader, this.Serialize<StripeWebhookSetupResponse>);
        }
        /// <summary>
        /// POST call to `/basic/payments/coupon/purchase/track` endpoint.
        /// </summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="GetProductResponse"/></returns>
        public virtual Promise<GetProductResponse> GetStripeProduct(string sku, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/payments/stripe/product";
            string gsQuery = "?";
            System.Collections.Generic.List<string> gsQueries = new System.Collections.Generic.List<string>();
            gsQueries.Add(string.Concat("sku=", _requester.EscapeURL(sku.ToString())));
            if ((gsQueries.Count > 0))
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        public virtual Promise<PaymentResultResponse> PostStripePurchaseVerify(VerifyPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/payments/stripe/purchase/verify";
            // make the request and return the result
            return _requester.Request<PaymentResultResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<PaymentResultResponse>);
        }
        /// <summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        public virtual Promise<PaymentResultResponse> PostStripePurchaseFail(FailPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/payments/stripe/purchase/fail";
            // make the request and return the result
            return _requester.Request<PaymentResultResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<PaymentResultResponse>);
        }
        /// <summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeginPurchaseResponse"/></returns>
        public virtual Promise<BeginPurchaseResponse> PostStripePurchaseBegin(BeginPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/payments/stripe/purchase/begin";
            // make the request and return the result
            return _requester.Request<BeginPurchaseResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<BeginPurchaseResponse>);
        }
        /// <summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="PaymentResultResponse"/></returns>
        public virtual Promise<PaymentResultResponse> PostStripePurchaseTrack(TrackPurchaseRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/payments/stripe/purchase/track";
            // make the request and return the result
            return _requester.Request<PaymentResultResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<PaymentResultResponse>);
        }
        /// <summary>

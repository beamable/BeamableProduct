...
namespace Beamable.Api.Autogenerated.Payments
{
	...
	public partial interface IPaymentsApi
	{
		...
		Promise<SubscriptionVerificationResponse> GetFacebookUpdate(string hubChallenge, string hubMode, string hubVerifyToken, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)][System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
	...
	public partial class PaymentsApi : IPaymentsApi
	{
		...
		/// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
		/// <returns>A promise containing the <see cref="SubscriptionVerificationResponse"/></returns>
		public virtual Promise<SubscriptionVerificationResponse> GetFacebookUpdate(string hubChallenge, string hubMode, string hubVerifyToken, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)][System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
		{

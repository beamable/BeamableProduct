...
namespace Beamable.Api.Autogenerated.Beamo
{
    ...
    public partial interface IBeamBeamoApi
    {
        ...
        /// <summary>
        /// GET call to `/api/beamo/loglevel-context` endpoint.
        /// </summary>
        /// <param name="routingKey"></param>
        /// <param name="serviceName"></param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoV2LogSwitchContextDocument"/></returns>
        Promise<BeamoV2LogSwitchContextDocument> GetLoglevelContext([System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string> routingKey, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string> serviceName, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        /// POST call to `/api/beamo/loglevel-context` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="BeamoV2LogSwitchContextDocument"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoV2EmptyMessage"/></returns>
        Promise<BeamoV2EmptyMessage> PostLoglevelContext(BeamoV2LogSwitchContextDocument gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
    }
    public partial class BeamBeamoApi : IBeamBeamoApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoV2LogSwitchContextDocument"/></returns>
        public virtual Promise<BeamoV2LogSwitchContextDocument> GetLoglevelContext([System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string> routingKey, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string> serviceName, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/api/beamo/loglevel-context";
            string gsQuery = "?";
            System.Collections.Generic.List<string> gsQueries = new System.Collections.Generic.List<string>();
            ...
            // make the request and return the result
            return _requester.Request<BeamoV2LogSwitchContextDocument>(Method.GET, gsUrl, default(object), includeAuthHeader, this.Serialize<BeamoV2LogSwitchContextDocument>);
        }
        /// <summary>
        /// POST call to `/api/beamo/loglevel-context` endpoint.
        /// </summary>
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoV2EmptyMessage"/></returns>
        public virtual Promise<BeamoV2EmptyMessage> PostLoglevelContext(BeamoV2LogSwitchContextDocument gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/api/beamo/loglevel-context";
            // make the request and return the result
            return _requester.Request<BeamoV2EmptyMessage>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<BeamoV2EmptyMessage>);

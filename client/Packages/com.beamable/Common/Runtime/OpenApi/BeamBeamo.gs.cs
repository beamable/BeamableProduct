...
namespace Beamable.Api.Autogenerated.Beamo
{
    ...
    public partial interface IBeamBeamoApi
    {
        ...
        /// <summary>
        /// Get presigned upload URLs for private binary content in the caller's scope (portal
        ///extension files, schema documents) — the upload counterpart of GetManifestContentUrls
        ///and the C# analog of the legacy /basic/content/binary endpoint.
        /// 
        /// POST call to `/api/beamo/content/binary` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="BeamoV2SaveBinaryContentRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoV2SaveBinaryContentResponse"/></returns>
        Promise<BeamoV2SaveBinaryContentResponse> PostContentBinary(BeamoV2SaveBinaryContentRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
        ...
        /// <summary>
        /// Authorize a docker registry request. Called by the registry's nginx as an auth_request
        ///subrequest carrying the original request method and URI; only the response status code
        ///is used (200 allows, 401/403 deny).
        /// 
        /// GET call to `/api/beamo/registry/auth` endpoint.
        /// </summary>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoV2EmptyMessage"/></returns>
        Promise<BeamoV2EmptyMessage> GetRegistryAuth([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
    ...
    public partial class BeamBeamoApi : IBeamBeamoApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoV2SaveBinaryContentResponse"/></returns>
        public virtual Promise<BeamoV2SaveBinaryContentResponse> PostContentBinary(BeamoV2SaveBinaryContentRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/api/beamo/content/binary";
            // make the request and return the result
            return _requester.Request<BeamoV2SaveBinaryContentResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<BeamoV2SaveBinaryContentResponse>);
        }
        /// <summary>
        /// Promote the current manifest from a source realm to the requesting realm.
        ///DEPRECATED: This endpoint is required for legacy Scala proxy calls.
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="BeamoV2EmptyMessage"/></returns>
        public virtual Promise<BeamoV2EmptyMessage> GetRegistryAuth([System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/api/beamo/registry/auth";
            // make the request and return the result
            return _requester.Request<BeamoV2EmptyMessage>(Method.GET, gsUrl, default(object), includeAuthHeader, this.Serialize<BeamoV2EmptyMessage>);
        }
        /// <summary>
        /// Get the Docker container registry URI for the current platform. When service names are
        ///provided, also returns the canonical repository name each service must be pushed to for

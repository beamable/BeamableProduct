...
namespace Beamable.Api.Open.Accounts
{
    ...
    public interface IAccountsApiObjectApi
    {
        Promise<Account> PutAdminEmail(string objectId, EmailUpdateRequest gsReq);
        Promise<AvailableRolesResponse> GetAvailableRoles(string objectId, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        Promise<AccountRolesReport> GetRoleReport(string objectId);
        Promise<EmptyResponse> PutRole(string objectId, UpdateRole gsReq);
        Promise<EmptyResponse> DeleteRole(string objectId, DeleteRole gsReq);
        Promise<EmptyResponse> PutAdminScope(string objectId, UpdateRole gsReq);
        Promise<EmptyResponse> DeleteAdminScope(string objectId, DeleteRole gsReq);
        Promise<EmptyResponse> PutAdminThirdParty(string objectId, TransferThirdPartyAssociation gsReq);
        Promise<EmptyResponse> DeleteAdminThirdParty(string objectId, DeleteThirdPartyAssociation gsReq);
        Promise<Account> Put(string objectId, AccountUpdate gsReq);
        Promise<Account> DeleteAdminForget(string objectId);
    }
    public class AccountsApiObjectApi : IAccountsApiObjectApi
    {

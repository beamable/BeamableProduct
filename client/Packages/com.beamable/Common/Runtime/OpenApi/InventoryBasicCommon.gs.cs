...
namespace Beamable.Api.Autogenerated.Inventory
{
    ...
    public partial class InventoryApi : IInventoryApi
    {
        ...
        public InventoryApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

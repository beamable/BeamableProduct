...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    {
        public OptionalAccount account = new OptionalAccount();
        public OptionalString challenge_token = new OptionalString();
        public OptionalTokenResponse token = new OptionalTokenResponse();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("account") 
                        || ((account != default(OptionalAccount)) 
                        && account.HasValue)))
            {
    ...
    [System.SerializableAttribute()]
    public class OptionalAccount : Beamable.Common.Content.Optional<Account>
    {
        public OptionalAccount()
        {
        }
        public OptionalAccount(Account value)
        {
            HasValue = true;
            Value = value;
        }

...
namespace Beamable.Api.Autogenerated.Models
{
    ...
    {
        public OptionalString joined = new OptionalString();
        public OptionalString playerId = new OptionalString();
        public OptionalArrayOfTag tags = new OptionalArrayOfTag();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("joined") 
                        || ((joined != default(OptionalString)) 
                        && joined.HasValue)))
            {
    ...
    {
        public OptionalString description = new OptionalString();
        public OptionalString lastOnline = new OptionalString();
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("lastOnline") 
                        || ((lastOnline != default(OptionalString)) 
                        && lastOnline.HasValue)))
            {
                s.Serialize("lastOnline", ref lastOnline.Value);
    ...
    public partial class JobExecutionEvent : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public OptionalString executionTime = new OptionalString();
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("executionTime") 
                        || ((executionTime != default(OptionalString)) 
                        && executionTime.HasValue)))
            {
                s.Serialize("executionTime", ref executionTime.Value);
    ...
    {
        public OptionalString id = new OptionalString();
        public OptionalJobActionDto jobAction = new OptionalJobActionDto();
        public OptionalString name = new OptionalString();
        public OptionalJobRetryPolicy retryPolicy = new OptionalJobRetryPolicy();
        public OptionalString source = new OptionalString();
        public OptionalArrayOfJobTriggerDto triggers = new OptionalArrayOfJobTriggerDto();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("id") 
                        || ((id != default(OptionalString)) 
            ...
            if ((s.HasKey("jobAction") 
                        || ((jobAction != default(OptionalJobActionDto)) 
                        && jobAction.HasValue)))
            {
                s.Serialize("jobAction", ref jobAction.Value);
                jobAction.HasValue = true;
            }
            if ((s.HasKey("name") 
                        || ((name != default(OptionalString)) 
                        && name.HasValue)))
            ...
            if ((s.HasKey("triggers") 
                        || ((triggers != default(OptionalArrayOfJobTriggerDto)) 
                        && triggers.HasValue)))
            {
                s.SerializeArray("triggers", ref triggers.Value);
                triggers.HasValue = true;
            }
        }
    }
    [System.SerializableAttribute()]
    public partial class JobDefinitionSaveResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString jobId = new OptionalString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
    ...
    [System.SerializableAttribute()]
    public partial class ApiSchedulerJobsGetSchedulerResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
        }
    ...
    [System.SerializableAttribute()]
    public partial class JobDefinitionResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString id = new OptionalString();
        public OptionalJobActionDto jobAction = new OptionalJobActionDto();
        public OptionalString lastUpdate = new OptionalString();
        public OptionalString name = new OptionalString();
        public OptionalJobRetryPolicy retryPolicy = new OptionalJobRetryPolicy();
        public OptionalString source = new OptionalString();
        public OptionalArrayOfJobTriggerDto triggers = new OptionalArrayOfJobTriggerDto();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("lastUpdate") 
                        || ((lastUpdate != default(OptionalString)) 
                        && lastUpdate.HasValue)))
            {
                s.Serialize("lastUpdate", ref lastUpdate.Value);
    ...
    [System.SerializableAttribute()]
    public partial class ApiSchedulerJobActivityGetSchedulerResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
        }
    ...
    [System.SerializableAttribute()]
    public partial class ApiSchedulerJobNextExecutionsGetSchedulerResponse : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
        }
    ...
    [System.SerializableAttribute()]
    public partial class JobActionDto : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString type = new OptionalString();
        public OptionalObject value = new OptionalObject();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("type") 
                        || ((type != default(OptionalString)) 
    ...
    [System.SerializableAttribute()]
    public partial class JobTriggerDto : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString type = new OptionalString();
        public OptionalObject value = new OptionalObject();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
    ...
    [System.SerializableAttribute()]
    public partial class HttpCall : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString body = new OptionalString();
    ...
    [System.SerializableAttribute()]
    public partial class PublishMessage : Beamable.Serialization.JsonSerializable.ISerializable
    {
    ...
    [System.SerializableAttribute()]
    public partial class ServiceCall : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString body = new OptionalString();
        public OptionalString method = new OptionalString();
        public OptionalString uri = new OptionalString();
    ...
    [System.SerializableAttribute()]
    public partial class CronTrigger : Beamable.Serialization.JsonSerializable.ISerializable
    {
    ...
    [System.SerializableAttribute()]
    public partial class ExactTrigger : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public OptionalString executeAt = new OptionalString();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            if ((s.HasKey("executeAt") 
                        || ((executeAt != default(OptionalString)) 
                        && executeAt.HasValue)))
            {
                s.Serialize("executeAt", ref executeAt.Value);
    ...
    public interface IOneOf_ContentOrTextOrBinary : Beamable.Serialization.JsonSerializable.ISerializable
    {
    }
    ...
    public partial class GroupUser : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public long gamerTag;
        public OptionalArrayOfInFlightMessage inFlight = new OptionalArrayOfInFlightMessage();
        public MapOfArrayOfString member = new MapOfArrayOfString();
        public OptionalArrayOfGroupScoreBinding scores = new OptionalArrayOfGroupScoreBinding();
        public long updated;
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            s.SerializeDictionary<MapOfArrayOfString, string[]>("member", ref member);
            if ((s.HasKey("scores") 
                        || ((scores != default(OptionalArrayOfGroupScoreBinding)) 
                        && scores.HasValue)))
            {
    ...
    [System.SerializableAttribute()]
    public class OptionalJobActionDto : Beamable.Common.Content.Optional<JobActionDto>
    {
        public OptionalJobActionDto()
        {
        }
        public OptionalJobActionDto(JobActionDto value)
        {
            HasValue = true;
            Value = value;
        }
    ...
    [System.SerializableAttribute()]
    public class OptionalArrayOfJobTriggerDto : Beamable.Common.Content.OptionalArray<JobTriggerDto>
    {
        public OptionalArrayOfJobTriggerDto()
        {
        }
        public OptionalArrayOfJobTriggerDto(JobTriggerDto[] value)
        {
            HasValue = true;
            Value = value;
        }

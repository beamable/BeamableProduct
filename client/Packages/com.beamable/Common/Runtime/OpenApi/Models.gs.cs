...
namespace Beamable.Api.Autogenerated.Models
{
	...
	public partial class ExternalIdentity : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			s.Serialize("providerAddress", ref providerAddress);
	...
	[System.SerializableAttribute()]
	public partial class ExternalIdentityRequest : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			...
			s.Serialize("provider_address", ref provider_address);
		}
	}
	[System.SerializableAttribute()]
	...
	public partial class ChallengeSolution : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			s.Serialize("challengeToken", ref challengeToken);
	...
	public partial class TokenRequestWrapper : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public OptionalString password = new OptionalString();
		public OptionalString provider_address = new OptionalString();
		...
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			...
			if ((s.HasKey("provider_address")
						|| ((provider_address != default(OptionalString))
						&& provider_address.HasValue)))
			{
				s.Serialize("provider_address", ref provider_address.Value);
				provider_address.HasValue = true;
			}

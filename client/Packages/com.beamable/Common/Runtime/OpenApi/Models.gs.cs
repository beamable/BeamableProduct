...
namespace Beamable.Api.Autogenerated.Models
{
	...
	[System.SerializableAttribute()]
	public class RealmsBasicAccount : Beamable.Serialization.JsonSerializable.ISerializable
	{
		public OptionalLong created = new OptionalLong();
		public string password;
	...
	[System.SerializableAttribute()]
	public class ChatV2ObjectMessage : Beamable.Serialization.JsonSerializable.ISerializable
	{
	...
	public class AnnouncementContent : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public OptionalAnnouncementsBasicPlayerReward gift = new OptionalAnnouncementsBasicPlayerReward();
	...
	[System.SerializableAttribute()]
	public class AnnouncementsBasicPlayerReward : Beamable.Serialization.JsonSerializable.ISerializable
	{
	...
	[System.SerializableAttribute()]
	public class AnnouncementsObjectPlayerReward : Beamable.Serialization.JsonSerializable.ISerializable
	{
		public MapOfString addCurrencyMap = new MapOfString();
		public ItemCreateRequest[] addItemRequests;
		public OptionalNewItemRewardArray addItems = new OptionalNewItemRewardArray();
	...
	public class AnnouncementView : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public ClientDataEntry[] clientDataList;
		public OptionalString endDate = new OptionalString();
		public OptionalAnnouncementsObjectPlayerReward gift = new OptionalAnnouncementsObjectPlayerReward();
		public string id;
		public bool isClaimed;
		public bool isDeleted;
		public bool isRead;
	...
	[System.SerializableAttribute()]
	public class MailBasicPlayerReward : Beamable.Serialization.JsonSerializable.ISerializable
	{
		public MapOfString addCurrencyMap = new MapOfString();
		public ItemCreateRequest[] addItemRequests;
		public OptionalNewItemRewardArray addItems = new OptionalNewItemRewardArray();
	...
	[System.SerializableAttribute()]
	public class MailBasicSendMailRequest : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public OptionalMailBasicPlayerReward playerRewards = new OptionalMailBasicPlayerReward();
	...
	public class Message : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public OptionalMapOfObject expires = new OptionalMapOfObject();
		public long id;
		public OptionalMailBasicPlayerReward playerRewards = new OptionalMailBasicPlayerReward();
		public long receiverGamerTag;
		public OptionalMailRewards rewards = new OptionalMailRewards();
		public long senderGamerTag;
		public MapOfObject sent = new MapOfObject();
		public string state;
		public OptionalString subject = new OptionalString();
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			...
			if ((s.HasKey("expires")
						|| ((expires != default(OptionalMapOfObject))
						&& expires.HasValue)))
			{
				s.SerializeDictionary<MapOfObject, object>("expires", ref expires.Value);
				expires.HasValue = true;
			}
			s.Serialize("id", ref id);
			s.Serialize("receiverGamerTag", ref receiverGamerTag);
			s.Serialize("senderGamerTag", ref senderGamerTag);
			s.SerializeDictionary<MapOfObject, object>("sent", ref sent);
			s.Serialize("state", ref state);
			if ((s.HasKey("subject")
						|| ((subject != default(OptionalString))
						&& subject.HasValue)))
	...
	[System.SerializableAttribute()]
	public class MailBasicBulkSendMailRequest : Beamable.Serialization.JsonSerializable.ISerializable
	{
	...
	[System.SerializableAttribute()]
	public class MailObjectPlayerReward : Beamable.Serialization.JsonSerializable.ISerializable
	{
		public MapOfString addCurrencyMap = new MapOfString();
		public ItemCreateRequest[] addItemRequests;
		public OptionalNewItemRewardArray addItems = new OptionalNewItemRewardArray();
	...
	public class SendMailObjectRequest : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public OptionalString expires = new OptionalString();
		public OptionalLong id = new OptionalLong();
		public OptionalMailObjectPlayerReward playerRewards = new OptionalMailObjectPlayerReward();
		public OptionalMailRewards rewards = new OptionalMailRewards();
		public long senderGamerTag;
		public OptionalString subject = new OptionalString();
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
	...
	[System.SerializableAttribute()]
	public class MailObjectSendMailRequest : Beamable.Serialization.JsonSerializable.ISerializable
	{
		public OptionalAttachmentRequestArray attachments = new OptionalAttachmentRequestArray();
		public OptionalString body = new OptionalString();
		public OptionalLong bodyRef = new OptionalLong();
	...
	[System.SerializableAttribute()]
	public class MailObjectBulkSendMailRequest : Beamable.Serialization.JsonSerializable.ISerializable
	{
		public MailObjectSendMailRequest[] sendMailRequests;
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			s.SerializeArray("sendMailRequests", ref sendMailRequests);
		}
	...
	[System.SerializableAttribute()]
	public class OptionalAnnouncementsBasicPlayerReward : Beamable.Common.Content.Optional<AnnouncementsBasicPlayerReward>
	{
		public OptionalAnnouncementsBasicPlayerReward()
		{
		}
		public OptionalAnnouncementsBasicPlayerReward(AnnouncementsBasicPlayerReward value)
		{
			HasValue = true;
			Value = value;
		}
	...
	[System.SerializableAttribute()]
	public class OptionalAnnouncementsObjectPlayerReward : Beamable.Common.Content.Optional<AnnouncementsObjectPlayerReward>
	{
		public OptionalAnnouncementsObjectPlayerReward()
		{
		}
		public OptionalAnnouncementsObjectPlayerReward(AnnouncementsObjectPlayerReward value)
		{
			HasValue = true;
			Value = value;
		}
	...
	[System.SerializableAttribute()]
	public class OptionalMailBasicPlayerReward : Beamable.Common.Content.Optional<MailBasicPlayerReward>
	{
		public OptionalMailBasicPlayerReward()
		{
		}
		public OptionalMailBasicPlayerReward(MailBasicPlayerReward value)
		{
			HasValue = true;
			Value = value;
		}
	...
	[System.SerializableAttribute()]
	public class OptionalMailObjectPlayerReward : Beamable.Common.Content.Optional<MailObjectPlayerReward>
	{
		public OptionalMailObjectPlayerReward()
		{
		}
		public OptionalMailObjectPlayerReward(MailObjectPlayerReward value)
		{
			HasValue = true;
			Value = value;
		}

...
namespace Beamable.Api.Autogenerated.Models
{
	...
	public partial class CurrencyArchetype : Beamable.Serialization.JsonSerializable.ISerializable
	{
		...
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			...
			if ((s.HasKey("proxy")
						|| ((proxy != default(OptionalInventoryProxySettings))
						&& proxy.HasValue)))
			{
	...
	{
		public OptionalString namespaceKey = new OptionalString();
		public string service;
		public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
		{
			if ((s.HasKey("namespace")
						|| ((namespaceKey != default(OptionalString))
						&& namespaceKey.HasValue)))
			{
				s.Serialize("namespace", ref namespaceKey.Value);
				namespaceKey.HasValue = true;
			}
			s.Serialize("service", ref service);
		}
	}

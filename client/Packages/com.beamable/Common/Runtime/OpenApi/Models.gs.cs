...
namespace Beamable.Api.Open.Models
{
    ...
    public class EventObjectData : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public MapOfObject state = new MapOfObject();
        public bool running;
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            s.SerializeDictionary<MapOfObject, object>("state", ref state);
            s.Serialize("running", ref running);
    ...
    public class GroupCreate : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public MapOfObject type = new MapOfObject();
        public int maxSize;
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            s.SerializeDictionary<MapOfObject, object>("type", ref type);
    ...
    {
        public string playerId;
        public MapOfObject source = new MapOfObject();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            s.Serialize("playerId", ref playerId);
            s.SerializeDictionary<MapOfObject, object>("source", ref source);
        }
    }
    [System.SerializableAttribute()]
    ...
    [System.SerializableAttribute()]
    public class Function1 : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
        }
    ...
    [System.SerializableAttribute()]
    public class DateTime : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public int dayOfYear;
        public int minuteOfHour;
        public Chronology chronology = new Chronology();
        ...
        public DateTimeZone zone = new DateTimeZone();
        ...
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            s.Serialize("minuteOfHour", ref minuteOfHour);
            s.Serialize("dayOfWeek", ref dayOfWeek);
            s.Serialize("hourOfDay", ref hourOfDay);
            s.Serialize("dayOfMonth", ref dayOfMonth);
            s.Serialize("yearOfEra", ref yearOfEra);
            s.Serialize("year", ref year);
            s.Serialize("secondOfDay", ref secondOfDay);
            s.Serialize("yearOfCentury", ref yearOfCentury);
            s.Serialize("equalNow", ref equalNow);
            s.Serialize("afterNow", ref afterNow);
            s.Serialize("secondOfMinute", ref secondOfMinute);
            s.Serialize("monthOfYear", ref monthOfYear);
            s.Serialize("millis", ref millis);
            s.Serialize("beforeNow", ref beforeNow);
            s.Serialize("centuryOfEra", ref centuryOfEra);
            s.Serialize("minuteOfDay", ref minuteOfDay);
            s.Serialize("era", ref era);
            s.Serialize("millisOfDay", ref millisOfDay);
            s.Serialize("millisOfSecond", ref millisOfSecond);
            s.Serialize("weekOfWeekyear", ref weekOfWeekyear);
            s.Serialize("weekyear", ref weekyear);
        }
    }
    [System.SerializableAttribute()]
    ...
    [System.SerializableAttribute()]
    public class DateTimeZone : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public string id;
        ...
        {
            s.Serialize("id", ref id);
            s.Serialize("fixed", ref fixedKey);
        }
    }
    [System.SerializableAttribute()]
    ...
    [System.SerializableAttribute()]
    public class Chronology : Beamable.Serialization.JsonSerializable.ISerializable
    {
        public DateTimeZone zone = new DateTimeZone();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
    ...
    {
        public Function1 listingInfoDefault2 = new Function1();
        public OfferDefinition[] offerDefinitions;
        public Store[] stores;
        public long version;
        public OptionalSKUDefinitions listingInfoDefault3 = new OptionalSKUDefinitions();
        public MapOfObject created = new MapOfObject();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            s.SerializeArray("offerDefinitions", ref offerDefinitions);
    ...
    public class Store : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public OptionalString title = new OptionalString();
        public bool storeWithAnnotationsDefault3;
        public DateTime storeWithAnnotationsDefault2 = new DateTime();
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            s.Serialize("storeWithAnnotations$default$3", ref storeWithAnnotationsDefault3);
        }
    }
    [System.SerializableAttribute()]
    ...
    public class LocalizationRef : Beamable.Serialization.JsonSerializable.ISerializable
    {
        ...
        public OptionalString translationDefault1 = new OptionalString();
        public bool empty;
        public virtual void Serialize(Beamable.Serialization.JsonSerializable.IStreamSerializer s)
        {
            ...
            if ((s.HasKey("translation$default$1") 
                        || ((translationDefault1 != default(OptionalString)) 
                        && translationDefault1.HasValue)))
            {
                s.Serialize("translation$default$1", ref translationDefault1.Value);
                translationDefault1.HasValue = true;
            }
            s.Serialize("empty", ref empty);
        }
    }
    ...
    [System.SerializableAttribute()]
    public class OptionalSKUDefinitions : Beamable.Common.Content.Optional<SKUDefinitions>
    {
        public OptionalSKUDefinitions()
        {
        }
        public OptionalSKUDefinitions(SKUDefinitions value)
        {
            HasValue = true;
            Value = value;
        }

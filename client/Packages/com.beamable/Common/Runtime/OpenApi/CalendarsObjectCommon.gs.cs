...
namespace Beamable.Api.Autogenerated.Calendars
{
    ...
    public partial class CalendarsApi : ICalendarsApi
    {
        ...
        public CalendarsApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

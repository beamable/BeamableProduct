...
namespace Beamable.Api.Autogenerated.Presence
{
    ...
    public partial class BeamPresenceApi : IBeamPresenceApi
    {
        ...
        public BeamPresenceApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

...
namespace Beamable.Api.Autogenerated.GroupUsers
{
    ...
    {
        /// <summary>
        /// GET call to `/object/group-users/{objectId}/availability` endpoint.
        /// </summary>
        ...
        /// <summary>
        /// GET call to `/object/group-users/{objectId}/recommended` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        ...
        /// <summary>
        /// POST call to `/object/group-users/{objectId}/join` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        ...
        /// <summary>
        /// DELETE call to `/object/group-users/{objectId}/join` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        /// <param name="gsReq">The <see cref="GroupMembershipRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        ...
        /// <summary>
        /// POST call to `/object/group-users/{objectId}/group` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        ...
        /// <summary>
        /// GET call to `/object/group-users/{objectId}/search` endpoint.
        /// </summary>
        ...
        /// <summary>
        /// GET call to `/object/group-users/{objectId}/` endpoint.
        /// </summary>
        /// <param name="objectId">Gamertag of the player.Underlying objectId type is integer in format int64.</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>

...
namespace Beamable.Api.Autogenerated.Beam
{
    ...
    public partial class BeamTicketApi : IBeamTicketApi
    {
        ...
        public BeamTicketApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))] [System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
        {

<<<<<<<< HEAD:client/Packages/com.beamable/Common/Runtime/OpenApi/BeamMatchCommon.gs.cs
...
namespace Beamable.Api.Autogenerated.Match
{
	...
	public partial class BeamMatchApi : IBeamMatchApi
	{
		...
		public BeamMatchApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))][System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
		{
...
namespace Beamable.Api.Autogenerated.Session
{
	...
	public partial class SessionApi : ISessionApi
	{
		...
		private IDependencyProvider _provider;
		private System.Collections.Generic.List<Beamable.Serialization.JsonSerializable.ISerializableFactory> _serializationFactories;
		public SessionApi(IBeamableRequester requester, [System.Runtime.InteropServices.DefaultParameterValueAttribute(default(Beamable.Common.Dependencies.IDependencyProvider))][System.Runtime.InteropServices.OptionalAttribute()] IDependencyProvider provider)
		{
			this._requester = requester;
			_provider = provider;
			_serializationFactories = new System.Collections.Generic.List<Beamable.Serialization.JsonSerializable.ISerializableFactory>();
...
>>>>>>>> origin/main:client/Packages/com.beamable/Common/Runtime/OpenApi/SessionBasicCommon.gs.cs

...
namespace Beamable.Api.Open.Tournaments
{
    ...
    public interface ITournamentsApiBasicApi
    {
    ...
    public class TournamentsApiBasicApi : ITournamentsApiBasicApi
    {
        private IBeamableRequester _requester;
        public TournamentsApiBasicApi(IBeamableRequester requester)
        {

...
namespace Beamable.Api.Autogenerated.Stats
{
	...
	public partial interface IStatsApi
	{
		...
		/// <param name="objectId">Format: domain.visibility.type.gamerTag</param>
		/// <returns>A promise containing the <see cref="StatsClientSubscribersResponse"/></returns>
		Promise<StatsClientSubscribersResponse> ObjectGetClientSubscribers(string objectId);
		/// <param name="objectId">Format: domain.visibility.type.gamerTag</param>
		/// <param name="stats"></param>
		/// <returns>A promise containing the <see cref="StatsResponse"/></returns>
	...
	public partial class StatsApi : IStatsApi
	{
		...
		/// <param name="objectId">Format: domain.visibility.type.gamerTag</param>
		/// <returns>A promise containing the <see cref="StatsClientSubscribersResponse"/></returns>
		public virtual Promise<StatsClientSubscribersResponse> ObjectGetClientSubscribers(string objectId)
		{
			string gsUrl = "/object/stats/{objectId}/client/subscribers";
			gsUrl = gsUrl.Replace("{objectId}", _requester.EscapeURL(objectId.ToString()));
			// make the request and return the result
			return _requester.Request<StatsClientSubscribersResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<StatsClientSubscribersResponse>);
		}
		/// <param name="objectId">Format: domain.visibility.type.gamerTag</param>
		/// <param name="stats"></param>
		/// <returns>A promise containing the <see cref="StatsResponse"/></returns>

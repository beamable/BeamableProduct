...
namespace Beamable.Api.Autogenerated.Content
{
    ...
    public partial interface IContentApi
    {
        ...
        /// <param name="omitTags">When true, the tags array is emitted empty for every entry. Defaults to false.</param>
        /// <param name="uid">UID of the content manifest</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        ...
        /// <summary>
        /// POST call to `/basic/content/binary/private/urls` endpoint.
        /// </summary>
        /// <param name="gsReq">The <see cref="GetBinaryDownloadUrlsRequest"/> instance to use for the request</param>
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="GetBinaryDownloadUrlsResponse"/></returns>
        Promise<GetBinaryDownloadUrlsResponse> PostBinaryPrivateUrls(GetBinaryDownloadUrlsRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        /// <summary>
    ...
    public partial class ContentApi : IContentApi
    {
        ...
        /// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
        /// <returns>A promise containing the <see cref="GetBinaryDownloadUrlsResponse"/></returns>
        public virtual Promise<GetBinaryDownloadUrlsResponse> PostBinaryPrivateUrls(GetBinaryDownloadUrlsRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader)
        {
            string gsUrl = "/basic/content/binary/private/urls";
            // make the request and return the result
            return _requester.Request<GetBinaryDownloadUrlsResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), includeAuthHeader, this.Serialize<GetBinaryDownloadUrlsResponse>);
        }
        /// <summary>
        /// GET call to `/basic/content/manifest/checksum` endpoint.
        /// </summary>

...
namespace Beamable.Api.Open.Stats
{
    ...
    public interface IStatsApiObjectApi
    {
        Promise<EmptyResponse> PostClientStringlist(string objectId, StatUpdateRequestStringListFormat gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
        Promise<StatsResponse> Get(string objectId, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)] [System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string> stats);
        Promise<EmptyResponse> Post(string objectId, StatUpdateRequest gsReq);
        Promise<EmptyResponse> Delete(string objectId, StatRequest gsReq);
        ...
        Promise<EmptyResponse> PostClient(string objectId, StatUpdateRequest gsReq, [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] [System.Runtime.InteropServices.OptionalAttribute()] bool includeAuthHeader);
    }
    public class StatsApiObjectApi : IStatsApiObjectApi
    {

...
namespace Beamable.Common.Pooling
{
	public class StringBuilderPool
	{
      ...
      public static StringBuilderPool StaticPool
      {
...
#else
		private static System.Threading.ThreadLocal<StringBuilderPool> safeStaticPoolLocal =
		...
		{
			AllocateToHeap =
				0, // Beyond capacity, builders are allocated into the heap to be garbage collected, this limits the amount of total memory this pool may use at a time.

			AllocateToPool =
				1 // Beyond capacity, builders are added to the pool, this limits GC, but means more reserved memory for the pool
		}

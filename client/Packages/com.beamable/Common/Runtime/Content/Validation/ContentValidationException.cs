...
namespace Beamable.Common.Content.Validation
{
	...
	public class ContentValidationException : ContentException
	{
		...
		public ValidationFieldWrapper Info
		{
			get;
		}

		public ContentValidationException(IContentObject content, ValidationFieldWrapper info) : base(
			content, generateMessage(info, ""))
		{
			Info = info;
		}

		public ContentValidationException(IContentObject content, ValidationFieldWrapper info, string message) : base(
			content, generateMessage(info, $" {message}"))
		{
			_message = message;
			Info = info;
		}
	...
	public class ContentNameValidationException : ContentException
	{
		...
		public int InvalidCharPosition
		{
			get;
		}

...
namespace Beamable.Common.Content
{
	...
	/// </summary>
	[System.Serializable]
	public abstract class AbsContentLink<TContent> : AbsContentRef<TContent>, IContentLink
	...
	[System.Serializable]
	public abstract class AbsContentRef<TContent> : BaseContentRef, IContentRef<TContent>
		where TContent : IContentObject, new()
	{
		public string Id;

		public abstract Promise<TContent>
			Resolve(string manifestID = ""); // the resolution of this method is different based on client/server.

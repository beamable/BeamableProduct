...
namespace Beamable.Common.Content.Serialization
{
	public class ClientContentSerializer : ContentSerializer<ContentObject>
	{
		...
		private static ContentSerializer<ContentObject> Instance =>
			_instance ?? (_instance = new ClientContentSerializer());
		...
		public static TContent DeserializeContent<TContent>(string json)
			where TContent : ContentObject, IContentObject, new() =>

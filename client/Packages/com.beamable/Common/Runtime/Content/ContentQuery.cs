...
namespace Beamable.Common.Content
{
	public class ContentQuery : DefaultQuery
	{
		...
		protected static readonly Dictionary<string, DefaultQueryParser.ApplyParseRule<ContentQuery>> StandardRules =
			new Dictionary<string, DefaultQueryParser.ApplyParseRule<ContentQuery>>
			{
				{"t", ApplyTypeParse}, {"id", DefaultQueryParser.ApplyIdParse}, {"tag", ApplyTagParse},
			};

		protected static readonly List<DefaultQueryParser.SerializeRule<ContentQuery>> StandardSerializeRules =

...
namespace Beamable.Common.Content
{
	...
	public class ContentObject : ScriptableObject, IContentObject, IRawJsonProvider
	{
		...
		internal const string TooltipMatchingIntervalSecs1 =
			"The rate by which the matchmaking system finds matches. Defaults to 10 seconds.";

		internal const string WriteSelf1 =
			"True, content is writeable via client C# and server. False, only via server";
		...
		public static IValidationContext ValidationContext
		{
			get;
			set;
		}
		...
		public static bool ShowChecksum
		{
			get;
			set;
		}

		public bool SerializeToConsoleRequested
		{
			get;
			set;
		}

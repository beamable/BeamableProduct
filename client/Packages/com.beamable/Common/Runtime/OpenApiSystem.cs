...
namespace Beamable.Api.Autogenerated
{
	public class OpenApiRegistration
	{
		public static void RegisterOpenApis(IDependencyBuilder builder)
		{
			...
			builder.AddSingleton<ICustomSerializer<ApiSchedulerJobsGetSchedulerResponse>, JobsResponseSerializer>();
	...
	public class JobsResponseSerializer : ICustomSerializer<ApiSchedulerJobsGetSchedulerResponse>
	{
		public ApiSchedulerJobsGetSchedulerResponse Deserialize(string data)
		{
			BeamableLogger.Log("Ah!");
			BeamableLogger.Log(data);
			return null;
		}
	}

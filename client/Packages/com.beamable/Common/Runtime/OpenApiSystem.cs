...
namespace Beamable.Api.Autogenerated
{
	public class OpenApiRegistration
	{
		public static void RegisterOpenApis(IDependencyBuilder builder)
		{
			...
			builder.AddOrOverrideScoped<IChatv2Api, Chatv2Api>();
			...
			builder.AddOrOverrideScoped<IMatchmakingApi, MatchmakingApi>();
			...
			builder.AddOrOverrideScoped<IBeamPlayerPresenceApi, BeamPlayerPresenceApi>();
			...
			builder.AddOrOverrideScoped<IBeamMatchApi, BeamMatchApi>();
			...
			builder.AddOrOverrideScoped<IBeamTicketApi, BeamTicketApi>();
		}
	}

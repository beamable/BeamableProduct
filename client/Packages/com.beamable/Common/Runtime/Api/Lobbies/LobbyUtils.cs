...
namespace Beamable.Experimental.Api.Lobbies
{
	public static class LobbyUtils
	{
		...
		public static JoinLobby GetJoinLobbyType(List<Tag> tags, [CanBeNull] string passcode = null)
		{
		...
		public static RemoveFromLobby GetRemoveFromLobbyType([CanBeNull] string playerId = null)
		{
		...
		public static RemoveTags GetRemoveTagsType(List<string> tags, [CanBeNull] string playerId)
		{

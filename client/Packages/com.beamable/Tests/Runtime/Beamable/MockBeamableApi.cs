...
namespace Packages.Beamable.Runtime.Tests.Beamable
{
	public class MockBeamableApi : IBeamableAPI
	{
		...
		public IExperimentalAPI Experimental
		{
			get;
		}

		public AnnouncementsService AnnouncementService
		{
			get;
			set;
		}
		...
		public CloudSavingService CloudSavingService
		{
			get;
			set;
		}
		...
		public GameRelayService GameRelayService
		{
			get;
			set;
		}
		...
		public Promise<IBeamablePurchaser> BeamableIAP
		{
			get;
		}
		...
		public Promise<IBeamablePurchaser> PaymentDelegate
		{
			get;
		}
		...
		public ITournamentApi TournamentsService
		{
			get;
		}
		...
		public ICloudDataApi TrialDataService
		{
			get;
		}

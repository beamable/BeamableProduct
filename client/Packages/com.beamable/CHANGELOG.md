...
- `CommerceService` uses `CoreConfiguration.CommerceListingRefreshSecondsMin` field to set a minimum delay between fetching store updates. The delay defaults to once a minute. 

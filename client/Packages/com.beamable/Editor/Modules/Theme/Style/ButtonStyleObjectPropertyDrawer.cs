			...
			switch (transitionProperty.enumNames[transitionProperty.enumValueIndex])
			{
				case nameof(Selectable.Transition.ColorTint):
					height += EditorGUI.GetPropertyHeight(
						property.FindPropertyRelative(nameof(ButtonStyleData.Colors)));
					break;
				case nameof(Selectable.Transition.SpriteSwap):
					height += EditorGUI.GetPropertyHeight(
						property.FindPropertyRelative(nameof(ButtonStyleData.SpriteState)));
					break;
				case nameof(Selectable.Transition.Animation):
					height += EditorGUI.GetPropertyHeight(
						property.FindPropertyRelative(nameof(ButtonStyleData.AnimationTriggers)));
					break;
			}
			...
			switch (transitionProperty.enumNames[transitionProperty.enumValueIndex])
			{
				...
				case nameof(Selectable.Transition.Animation):
					EditorGUI.PropertyField(
						rect, property.FindPropertyRelative(nameof(ButtonStyleData.AnimationTriggers)));
					break;
			}

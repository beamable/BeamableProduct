	...
	public class SessionParameterProviderCreator
	{
		...
		public static void CreateProviderScript()
		{
				...
				new StreamWriter(path))
			{
				...
				outfile.WriteLine(
					$"\tpublic override void {nameof(SessionParameterProvider.AddCustomParameters)}(Dictionary<string, string> parameters, User user) {{");
				outfile.WriteLine("\t\t");
				outfile.WriteLine("\t}");
				outfile.WriteLine("}");
			}
		...
		public static void After()
		{
			...
			if (SessionConfiguration.Instance.CustomParameterProvider == null || EditorUtility.DisplayDialog(
				"Set Beamable Session Parameter Provider",

...
namespace Beamable.Editor.Modules.EditorConfig
{
	public class EditorConfiguration : ModuleConfigurationObject
	{
		...
		[Tooltip(
			"These are advanced Beamable editor features. Please only use these if you are confident in what you are doing.")]
		...
		public override void OnFreshCopy()
		{
			...
			Advanced.DisableValidationPropertyDrawers =
				existing.Contains(BEAMABLE_DISABLE_CONTENT_VALIDATION_PROPERTYDRAWERS);
			Advanced.DisableContentInspector = existing.Contains(BEAMABLE_DISABLE_CONTENT_INSPECTOR);
			Advanced.DisableBeamableDictionaryPropertyDrawers =
				existing.Contains(BEAMABLE_DISABLE_DICT_PROPERTYDRAWERS);
			...
			Advanced.DisableBeamableDateStringPropertyDrawers =
				existing.Contains(BEAMABLE_DISABLE_DATE_STRING_PROPERTYDRAWERS);
		}
		...
		{
			[Tooltip(
				"[Danger] Beamable overrides the Inspector for any ContentObject class. If you wish to disable Beamable content inspector features, use this property.")]
			public bool DisableContentInspector;

			[Tooltip(
				"[Danger] Beamable provides an Optional type class, and a custom property drawer to edit instances of that Operational type. If you wish to disable the custom visualization, use this property.")]
			public bool DisableOptionalPropertyDrawers;

			[Tooltip(
				"[Danger] Beamable provides content validation inline in the inspector via a custom property drawer. If you wish to disable the custom validation visualization, use this property.")]
			public bool DisableValidationPropertyDrawers;

			[Tooltip(
				"[Danger] Beamable provides a dropdown UX for picking ContentRef objects through a custom property drawer. If you wish to disable this, use this property.")]
			public bool DisableContentRefPropertyDrawers;

			[Tooltip(
				"[Danger] Beamable provides a dictionary style object with a custom property drawer. if you wish to disable the property drawer, use this property.")]
			public bool DisableBeamableDictionaryPropertyDrawers;

			[Tooltip(
				"[Danger] Beamable provides a list style object with a custom property drawer. if you wish to disable the property drawer, use this property.")]
			public bool DisableBeamableListPropertyDrawers;

			[Tooltip(
				"[Danger] Internal Beamable Developers use this flag to enable preview features or system shortcuts. If you use this, expect subtle undocumented behaviour changes.")]
			public bool RunAsBeamableDeveloper;

			[Tooltip(
				"[Danger] Beamable provides a date-string custom property drawer. if you wish to disable the property drawer, use this property.")]

...
namespace Beamable.Editor.Content
{
	...
	{
		private Dictionary<string, ContentManifestReference> _lookup =
			new Dictionary<string, ContentManifestReference>();
	...
	{
		public Dictionary<string, LocalContentManifestEntry> Content =
			new Dictionary<string, LocalContentManifestEntry>();
	}

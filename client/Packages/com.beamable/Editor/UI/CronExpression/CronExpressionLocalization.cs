...
[CreateAssetMenu(fileName = "CronExpressionLocalization", menuName = "Cron/Localization/Cron Expression Localization")]
public class CronExpressionLocalization : ScriptableObject
{
    //public CronFileLanguage language;
    ...
    {
        return (string)typeof(CronExpressionLocalization).GetField(resourceName)?.GetValue(this);
    }
}

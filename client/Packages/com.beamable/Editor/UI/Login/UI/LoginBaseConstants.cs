namespace Beamable.Editor.Login.UI
{
	...
	{
		public const string BASE_PATH = "Packages/com.beamable/Editor/UI/Login/UI";
		...
		public const string CUSTOMER_CREATION_UNKNOWN_ERROR =
			"An unknown error occured. Please check the Unity console for more information.";
		...
		public const string BAD_CODE_ERROR =
			"The code you entered does not match the password reset code we sent to your email.";

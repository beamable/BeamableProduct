...
namespace Beamable.Editor.Content.Models
{
	...
	{
		static Dictionary<ContentModificationStatus, string> statusToString =
			new Dictionary<ContentModificationStatus, string>
			{
		...
		static Dictionary<string, ContentModificationStatus> stringToStatus =
			new Dictionary<string, ContentModificationStatus>();
	...
	public class ContentItemDescriptor
	{
		...
		public ContentValidationStatus ValidationStatus =>
		...
		public HashSet<string> AllTags =>
			new HashSet<string>(GetAllTags().Select(x => x.Tag)); // TODO: This could be cached.
		...
		public HashSet<string> ServerTags
		{
			get;
			private set;
		}

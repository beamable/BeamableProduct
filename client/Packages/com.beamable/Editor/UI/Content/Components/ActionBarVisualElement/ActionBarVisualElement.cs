...
namespace Beamable.Editor.Content.Components
{
	public class ActionBarVisualElement : ContentManagerComponent
	{
		...
		public override void Refresh()
		{
			...
			_validateButton.clickable.clicked += () =>
			{
				OnValidateButtonClicked?.Invoke();
			};
			...
			_downloadButton.clickable.clicked += () =>
			{
				OnDownloadButtonClicked?.Invoke();
			};

			_tagButton = Root.Q<Button>("tagButton");
			_tagButton.clickable.clicked += () =>
			{
				TagButton_OnClicked(_tagButton.worldBound);
			};
			...
			_statusButton.clickable.clicked += () =>
			{
				StatusButton_OnClicked(_statusButton.worldBound);
			};
			...
			_docsButton.clickable.clicked += () =>
			{
				OnDocsButtonClicked?.Invoke();
			};
		...
		private void HandlePublishButtonClick(ContextualMenuPopulateEvent evt)
		{
			...
			{
				evt.menu.BeamableAppendAction("Publish new Content namespace", pos =>
				{

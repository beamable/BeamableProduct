...
namespace Beamable.Editor.Content
{
	public class ContentManager
	{
		...
		public IContentObject AddItem()
		{
			...
			if (selectedContentTypeTreeViewItem == null)
			{
				BeamableLogger.LogError(
					new Exception("AddItem() failed. selectedContentTypeTreeViewItem must not be null."));
				return null;
			}
		...
		public Promise<List<ContentExceptionCollection>> ValidateContent(

...
namespace Beamable.Editor.Content
{
	...
	public static class ContentManagerConstants
	{
		...
		public const string DownloadMessageText =
			"Clicking download will overwrite local content changes with the content on published to Beamable.";

		public const string DownloadNoDataText =
			"There is no content to download. All your local content is up to date.";
		...
		public const string ResetContentMessagePreview =
			"This operation will remove all your local changes. You can't undo this operation. Are you sure you want to proceed?";

		public const string ResetContentCompleteMessage = "All Local Content has been successfully synchronized.";

		//
		public static string ContentListHeaderText =
			"Object Name                       Path                                     Tag";

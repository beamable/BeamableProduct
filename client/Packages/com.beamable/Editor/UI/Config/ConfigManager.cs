...
namespace Beamable.Editor.Config
{
	...
	public class ConfigManager
	{
		...
		public static IEnumerable<ConfigModuleDescriptor> MissingConfigurations =>
			ConfigModuleDescriptors.Where(d => !d.Exists);
		...
		public static List<ConfigModuleDescriptor> GetConfigDescriptors()
		{
			...
			foreach (var asm in AppDomain.CurrentDomain.GetAssemblies())
			{
				...
				{
					Debug.LogWarning(
						$"Unable to load asm {asm.FullName} and scan for configurations. {ex.Message}\n{ex.StackTrace}");
				}
			}

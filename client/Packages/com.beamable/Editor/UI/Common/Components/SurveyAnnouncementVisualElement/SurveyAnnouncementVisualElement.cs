...
namespace Beamable.Editor.Toolbox.Components
{
	...
	{
		public SurveyAnnouncementModel SurveyAnnouncementModel
		{
			get;
			set;
		}
		...
		public override void Refresh()
		{
			...
			surveyPositiveButton.clickable.clicked += () =>
				SurveyAnnouncementModel.OnOpinionSelected?.Invoke(SurveyResult.Positive);
			surveyPositiveButton.tooltip = "Happy with Beamable";

			var surveyNeutralButton = Root.Q<Button>("announcement-surveyNeutral");
			surveyNeutralButton.clickable.clicked += () =>
				SurveyAnnouncementModel.OnOpinionSelected?.Invoke(SurveyResult.Neutral);
			surveyNeutralButton.tooltip = "Ok with Beamable";

			var surveyNegativeButton = Root.Q<Button>("announcement-surveyNegative");
			surveyNegativeButton.clickable.clicked += () =>
				SurveyAnnouncementModel.OnOpinionSelected?.Invoke(SurveyResult.Negative);

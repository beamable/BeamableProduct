...
namespace Beamable.Editor.UI.Buss
{
	public class BussThemeSceneUtility
	{
		...
		public void Open(BussPrefabLoaderSource source, Scene scene)
		{
			this.source = source;
			this.scene = scene;
		...
		public void OnDuringSceneGui(SceneView obj)
		{
			#region draw labels
	...
	public class BussStage : PreviewSceneStage
	{
		...
		public BussPrefabLoaderSource source;
		private BussThemeSceneUtility util = new BussThemeSceneUtility();

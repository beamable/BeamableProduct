...
namespace Beamable.Editor.UI.Buss.Components
{
	public class StyleObjectVisualElement : BeamableVisualElement
	{
		...
		public const string COMMON =
			BeamableComponentsConstants.UI_PACKAGE_PATH + "/Buss/Components/styleObjectVisualElement";
		...
		private List<RequiredBUSSPropertyVisualElement> _propertyElements =
			new List<RequiredBUSSPropertyVisualElement>();

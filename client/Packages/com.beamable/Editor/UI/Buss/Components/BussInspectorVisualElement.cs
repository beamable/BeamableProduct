...
namespace Beamable.Editor.UI.Buss.Components
{
	public class BussInspectorVisualElement : BeamableVisualElement
	{
		public const string COMMON =
			BeamableComponentsConstants.UI_PACKAGE_PATH + "/Buss/Components/bussInspectorVisualElement";
		...
		public override void Refresh()
		{
			...
			_computedStyleElement =
				new StyleObjectVisualElement(new StyleRuleBundle(computedBundle, _currentSelection), false);

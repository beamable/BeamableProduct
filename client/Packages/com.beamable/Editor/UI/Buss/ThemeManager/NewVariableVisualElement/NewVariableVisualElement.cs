...
{
	public class NewVariableVisualElement : ThemeManagerComponent
	{
		...
		public NewVariableVisualElement(Action<string, IBussProperty> onPropertyCreated) : base(nameof(NewVariableVisualElement))
		{

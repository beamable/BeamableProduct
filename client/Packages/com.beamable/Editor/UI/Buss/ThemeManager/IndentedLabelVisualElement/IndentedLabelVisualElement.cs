...
namespace Beamable.Editor.UI.Components
{
	...
	public class IndentedLabelVisualElement : ThemeManagerBasicComponent
	{
		...
		public IndentedLabelVisualElement() : base(nameof(IndentedLabelVisualElement)) { }
		...
		public override void Init()
		{
			...
			var classLabel = new TextElement
			{
				name = "classLabel", text = BussNameUtility.ClassListString(_bussElement.Classes)
			};

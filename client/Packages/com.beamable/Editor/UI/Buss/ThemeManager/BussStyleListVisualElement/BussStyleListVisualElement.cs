...
{
	public class BussStyleListVisualElement : ThemeManagerBasicComponent
	{
		...
		public BussStyleListVisualElement(ThemeModel model) : base(nameof(BussStyleListVisualElement), false)
		{
			_model = model;

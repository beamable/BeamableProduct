...
{
	public class NewStyleSheetVisualElement : ThemeManagerComponent
	{
		...
		public NewStyleSheetVisualElement(List<BussStyleRule> initialRule) : base(nameof(NewStyleSheetVisualElement))
		{

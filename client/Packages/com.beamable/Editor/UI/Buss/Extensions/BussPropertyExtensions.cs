...
namespace Beamable.Editor.UI.Buss.Extensions
{
	...
	{
		public static IEnumerable<OptionalPropertyFieldWrapper> GenerateProperties(
			this BUSSProperty self,
			bool onlyEnabled = true,
			bool onlyDisabled = false,
			StyleRuleBundle trace = null)
		{
			...
			foreach (var optionalField in optionalFields)
			{
				...
				{
					yield return
						new OptionalPropertyFieldWrapper(self, optionalValue, optionalField, valueField, trace);
				}
			}
		}

		public static IEnumerable<RequiredBUSSPropertyVisualElement> GenerateElements(
			this BUSSProperty self,
			StyleRuleBundle model)
		{

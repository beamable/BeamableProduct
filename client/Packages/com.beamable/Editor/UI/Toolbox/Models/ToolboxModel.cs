...
namespace Beamable.Editor.Toolbox.Models
{
	public class ToolboxModel
	{
		...
		public IWidgetSource WidgetSource
		{
			get;
			private set;
		}

		public ToolboxQuery Query
		{
			get;
			private set;
		}
		...
		{
			WidgetSource =
				AssetDatabase.LoadAssetAtPath<WidgetSource>($"{ToolboxConstants.BASE_PATH}/Models/toolboxData.asset");

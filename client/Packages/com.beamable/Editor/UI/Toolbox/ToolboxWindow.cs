	...
	public class ToolboxWindow : EditorWindow
	{
		...
		private void CheckForDeps()
		{
			...
			EditorAPI.Instance.Then(api =>
			{
				...
				var button =
					new Button(() => Application.OpenURL("https://docs.unity3d.com/Manual/com.unity.textmeshpro.html"));
				...
				{
					api.CreateDependencies().Then(_ =>
					{
						_model.RemoveAnnouncement(welcomeAnnouncement);
					});
				};
		...
		private void ShowUpdateAvailableAnnouncement()
		{
			...
			BeamablePackageUpdateMeta.IsBlogSiteAvailable =
				BeamableWebRequester.IsBlogSpotAvailable(BeamablePackageUpdateMeta.NewestVersionNumber);

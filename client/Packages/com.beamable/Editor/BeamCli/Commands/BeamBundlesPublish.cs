...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    public partial class BundlesPublishArgs : Beamable.Common.BeamCli.IBeamCommandArgs
    {
        /// <summary>The bundle name to publish</summary>
        ...
        public string sln;
        /// <summary>The file path to a pre-generated bundle plan file using the `bundles plan` command</summary>
        public string fromPlan;
        /// <summary>Use the most recent plan generated for this bundle from the `bundles plan` command</summary>
    ...
    {
        public virtual BundlesPublishWrapper BundlesPublish(BundlesPublishArgs publishArgs)
        {
            // Create a list of arguments for the command
            System.Collections.Generic.List<string> genBeamCommandArgs = new System.Collections.Generic.List<string>();
            ...
            BundlesPublishWrapper genBeamCommandWrapper = new BundlesPublishWrapper();
            genBeamCommandWrapper.Command = command;
            // Return the command!
            return genBeamCommandWrapper;
        }
    }
    public partial class BundlesPublishWrapper : Beamable.Common.BeamCli.BeamCommandWrapper
    {
        public virtual BundlesPublishWrapper OnStreamPublishBundleCommandOutput(System.Action<ReportDataPoint<BeamPublishBundleCommandOutput>> cb)
        {
            this.Command.On("stream", cb);
            return this;
        }
        public virtual BundlesPublishWrapper OnBuildErrorsRunProjectBuildErrorStream(System.Action<ReportDataPoint<BeamRunProjectBuildErrorStream>> cb)
        {
            this.Command.On("buildErrors", cb);
            return this;
        }
        public virtual BundlesPublishWrapper OnProgressPlanReleaseProgress(System.Action<ReportDataPoint<BeamPlanReleaseProgress>> cb)
        {

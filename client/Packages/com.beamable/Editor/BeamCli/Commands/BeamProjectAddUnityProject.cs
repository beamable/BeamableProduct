...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    {
        /// <summary>Add a unity project to this beamable cli project</summary>
        /// <param name="path">Relative path to the Unity project</param>

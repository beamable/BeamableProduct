...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    {
        /// <summary>Resets services to default settings and cleans up docker images (if any exist)</summary>
        /// <param name="target">Either image|container|protocols.'image' will cleanup all your locally built images for the selected Beamo Services.
        ///'container' will stop all your locally running containers for the selected Beamo Services.
        ///'protocols' will reset all the protocol data for the selected Beamo Services back to default parameters</param>

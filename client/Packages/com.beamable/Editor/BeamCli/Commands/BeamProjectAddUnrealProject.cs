...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    {
        /// <summary>Add a unreal project to this beamable cli project</summary>
        /// <param name="path">Relative path to the Unreal project</param>

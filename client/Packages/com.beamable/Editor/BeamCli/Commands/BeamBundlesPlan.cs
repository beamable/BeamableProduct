...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    public partial class BundlesPlanArgs : Beamable.Common.BeamCli.IBeamCommandArgs
    {
    ...
    {
        public virtual BundlesPlanWrapper BundlesPlan(BundlesPlanArgs planArgs)
        {
            // Create a list of arguments for the command
            System.Collections.Generic.List<string> genBeamCommandArgs = new System.Collections.Generic.List<string>();
            ...
            BundlesPlanWrapper genBeamCommandWrapper = new BundlesPlanWrapper();
            genBeamCommandWrapper.Command = command;
            // Return the command!
            return genBeamCommandWrapper;
        }
    }
    public partial class BundlesPlanWrapper : Beamable.Common.BeamCli.BeamCommandWrapper
    {
        public virtual BundlesPlanWrapper OnStreamBundlePlanCommandOutput(System.Action<ReportDataPoint<BeamBundlePlanCommandOutput>> cb)
        {
            this.Command.On("stream", cb);
            return this;
        }
        public virtual BundlesPlanWrapper OnBuildErrorsRunProjectBuildErrorStream(System.Action<ReportDataPoint<BeamRunProjectBuildErrorStream>> cb)
        {
            this.Command.On("buildErrors", cb);
            return this;
        }
        public virtual BundlesPlanWrapper OnProgressPlanReleaseProgress(System.Action<ReportDataPoint<BeamPlanReleaseProgress>> cb)
        {

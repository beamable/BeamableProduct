...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    {
        public virtual ProjectReadSettingsWrapper ProjectReadSettings(ProjectReadSettingsArgs readSettingsArgs)
        {
            // Create a list of arguments for the command
            System.Collections.Generic.List<string> genBeamCommandArgs = new System.Collections.Generic.List<string>();
            ...
            genBeamCommandArgs.Add("read-settings");
            genBeamCommandArgs.Add(readSettingsArgs.Serialize());
            ...
            ProjectReadSettingsWrapper genBeamCommandWrapper = new ProjectReadSettingsWrapper();

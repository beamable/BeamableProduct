...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    {
        /// <summary>Gets the URL that we upload docker images into when deploying services remotely for this realm</summary>

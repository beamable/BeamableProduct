...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    public partial class ServerClearArgs : Beamable.Common.BeamCli.IBeamCommandArgs
    {
    ...
    {
        public virtual ServerClearWrapper ServerClear(ServerClearArgs clearArgs)
        {
            // Create a list of arguments for the command
            System.Collections.Generic.List<string> genBeamCommandArgs = new System.Collections.Generic.List<string>();
            ...
            genBeamCommandArgs.Add(clearArgs.Serialize());
            ...
            ServerClearWrapper genBeamCommandWrapper = new ServerClearWrapper();
            genBeamCommandWrapper.Command = command;
            // Return the command!
            return genBeamCommandWrapper;
        }
    }
    public partial class ServerClearWrapper : Beamable.Common.BeamCli.BeamCommandWrapper
    {
        public virtual ServerClearWrapper OnStreamServerKillCommandResult(System.Action<ReportDataPoint<BeamServerKillCommandResult>> cb)
        {

...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    {
        /// <summary>Gets the docker registry URL that we upload docker images into when deploying services remotely for this realm</summary>

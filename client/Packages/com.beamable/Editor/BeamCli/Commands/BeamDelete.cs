...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    public class DeleteArgs : Beamable.Common.BeamCli.IBeamCommandArgs
    {
        /// <summary></summary>
        public string uri;
    ...
    {
        public virtual Beamable.Common.BeamCli.IBeamCommand Delete(DeleteArgs deleteArgs)
        {
            // Create a list of arguments for the command
            System.Collections.Generic.List<string> genBeamCommandArgs = new System.Collections.Generic.List<string>();
            genBeamCommandArgs.Add("beam");
            genBeamCommandArgs.Add(defaultBeamArgs.Serialize());
            genBeamCommandArgs.Add("delete");
            genBeamCommandArgs.Add(deleteArgs.Serialize());

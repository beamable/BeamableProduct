...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    public partial class DeploymentAdminForceInjectArgs : Beamable.Common.BeamCli.IBeamCommandArgs
    {
        ...
        public virtual string Serialize()
        {
            ...
            // If the targetCid value was not default, then add it to the list of args.
            if ((this.targetCid != default(string)))
            {
                genBeamCommandArgs.Add(("--target-cid=" + this.targetCid));
            }
            // If the targetRealm value was not default, then add it to the list of args.
            if ((this.targetRealm != default(string)))
            {
                genBeamCommandArgs.Add(("--target-realm=" + this.targetRealm));
            }

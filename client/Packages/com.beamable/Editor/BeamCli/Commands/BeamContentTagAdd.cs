...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    public partial class ContentTagAddArgs : Beamable.Common.BeamCli.IBeamCommandArgs
    {
    ...
    {
        public virtual ContentTagAddWrapper ContentTagAdd(ContentTagAddArgs addArgs)
        {
            // Create a list of arguments for the command
            System.Collections.Generic.List<string> genBeamCommandArgs = new System.Collections.Generic.List<string>();
            ...
            ContentTagAddWrapper genBeamCommandWrapper = new ContentTagAddWrapper();
            genBeamCommandWrapper.Command = command;
            // Return the command!
            return genBeamCommandWrapper;
        }
    }
    public partial class ContentTagAddWrapper : Beamable.Common.BeamCli.BeamCommandWrapper
    {
    }
}

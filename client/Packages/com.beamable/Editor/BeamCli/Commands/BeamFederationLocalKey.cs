...
namespace Beamable.Editor.BeamCli.Commands
{
    ...
    public class FederationLocalKeyArgs : Beamable.Common.BeamCli.IBeamCommandArgs
    {
    ...
    public class FederationLocalKeyWrapper : Beamable.Common.BeamCli.BeamCommandWrapper
    {

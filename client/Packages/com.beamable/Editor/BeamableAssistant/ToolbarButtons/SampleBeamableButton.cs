...
namespace Beamable.Editor.ToolbarExtender
{
	...
	/// </summary>
	[CreateAssetMenu(menuName = "Beamable/Assistant/Sample Toolbar Button", fileName = "SampleBeamableButton", order = BeamableConstantsOLD.MENU_ITEM_PATH_ASSETS_BEAMABLE_ORDER_LAST)]

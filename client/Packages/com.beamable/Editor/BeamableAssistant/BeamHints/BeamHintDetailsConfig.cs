...
namespace Beamable.Editor.Assistant
{
	...
	/// hint details. 
	/// </summary>
	[CreateAssetMenu(fileName = "BeamHintDetailsConfig", menuName = "Beamable/Assistant/Hint Details", order = BeamableConstantsOLD.MENU_ITEM_PATH_ASSETS_BEAMABLE_ORDER_2)]

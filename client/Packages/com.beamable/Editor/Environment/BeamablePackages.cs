...
namespace Beamable.Editor.Environment
{
	...
	public static class BeamablePackageUpdateMeta
	{
		...
		public static bool IsInstallationIgnored
		{
			get;
			set;
		}

		public static bool IsBlogSiteAvailable
		{
			get;
			set;
		}

		public static bool IsBlogVisited
		{
			get;
			set;
		}
		...
		public static string CurrentServerVersionNumber
		{
			get;
			set;
		}

		public static string NewestVersionNumber =>
			EditorPrefs.GetString(BeamableEditorPrefsConstants.NEWEST_VERSION_NUMBER);

		public static string NewestServerVersionNumber =>
			EditorPrefs.GetString(BeamableEditorPrefsConstants.NEWEST_SERVER_VERSION_NUMBER);

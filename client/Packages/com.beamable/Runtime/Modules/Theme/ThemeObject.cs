...
namespace Beamable.Theme
{
	public class ThemeObject : ScriptableObject
	{
		...
		private PaletteBase[] AllPalettes =>
			new PaletteBase[]
			{
				ColorPalette, TextPalette, FontPalette, ImagePalette, GradientPalette, LayoutPalette,
				SelectablePalette, ButtonPalette, TransformPalette, WindowPalette, SoundPalette, StringPalette
			};

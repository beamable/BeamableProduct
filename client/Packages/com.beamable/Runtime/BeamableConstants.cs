public static class BeamableConstants
{
	...
	public const string BEAMABLE_LEGAL_WEBSITE =
		"https://app.termly.io/document/terms-of-use-for-website/c44e18e4-675f-4eeb-8fa4-a9a5267ec2c5";
	...
	public const string URL_BEAMABLE_BLOG_RELEASES_UNITY_SDK =
		"https://www.beamable.com/blog/beamable-releases-unity-sdk";
	...
	public const string URL_TOOL_WINDOW_CONTENT_NAMESPACES =
		"https://docs.beamable.com/docs/content-manager#namespaces";
	...
	public const string MENU_ITEM_PATH_WINDOW_BEAMABLE_HELP_DIAGNOSTIC_DATA =
		MENU_ITEM_PATH_WINDOW_BEAMABLE_HELP + "/Generate Diagnostic Info";

	public const string MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES = MENU_ITEM_PATH_WINDOW_BEAMABLE + "/Utilities";

	public const string MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_BEAMABLE_DEVELOPER =
		MENU_ITEM_PATH_WINDOW_BEAMABLE + "/Beamable Developer";

	public const string MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_MICROSERVICES =
		MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES + "/Microservices";

	//Menu Items: Window (#ifdef BEAMABLE_DEVELOPER)
	public const string MENU_ITEM_PATH_WINDOW_BEAMABLE_BEAMABLE_DEVELOPER_SAMPLES =
		MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_BEAMABLE_DEVELOPER + "/Samples";

	public const string MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_UNITY =
		MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_BEAMABLE_DEVELOPER + "/Unity";

	public const string MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_THEME_MANAGER =
		MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_BEAMABLE_DEVELOPER + "/Theme Manager";
	...
	public const string MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_SDF_GENERATOR =
		MENU_ITEM_PATH_WINDOW_BEAMABLE_UTILITIES_BEAMABLE_DEVELOPER + MENU_ITEM_PATH_WINDOW_BEAMABLE_BUSS +
		"/Open SDF Generator";
	...
	public const string MENU_ITEM_PATH_ASSETS_BEAMABLE_CONFIGURATIONS =
		MENU_ITEM_PATH_ASSETS_BEAMABLE + "/Configurations";

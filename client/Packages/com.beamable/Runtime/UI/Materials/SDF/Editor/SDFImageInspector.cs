...
public class SDFImageInspector : Editor {
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("outlineWidth"), new GUIContent("Outline Width"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("outlineColor"), new GUIContent("Outline Color"));
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("shadowThreshold"), new GUIContent("Shadow Threshold"));

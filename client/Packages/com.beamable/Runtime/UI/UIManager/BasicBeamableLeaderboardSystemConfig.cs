...
/// TODO:   - These are just a convenient way to configure a view with data it needs to correctly communicate with it's <see cref="IBeamableView.IDeps"/> (such as <see cref="LeaderboardView.IViewDependencies"/>)...
/// TODO:     I think this may be a better avenue.
/// TODO: What I'm worried about is that by making this a system declaration we will be forcing all <see cref="IBeamableView.IDeps"/> concrete implementations to have to know about this type...
/// TODO: Or, even worse, make the <see cref="IBeamableView.IDeps"/>'s API dependent on these types in some way...
/// </summary>
[CreateAssetMenu(menuName = "Beamable Systems/Leaderboard/Basic", fileName = "BasicBeamableLeaderboardSystemConfig", order = 0)]
public class BasicBeamableLeaderboardSystemConfig : ScriptableObject
{
    public BeamableDefaultLeaderboardSystem.SerializableConfig Configuration;
}

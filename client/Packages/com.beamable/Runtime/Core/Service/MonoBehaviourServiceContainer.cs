...
namespace Beamable.Service
{
		...
		where T : MonoBehaviour
	{
		...
		public T Resolve()
		{
			...
			{
				Debug.LogError(
					$"Application is quiting, but something is still resolving service {typeof(T).Name}, which is going to return null. Use check existence with ServiceManager before resolving on cleanup code");
			}

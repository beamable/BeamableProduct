...
namespace Beamable.Experimental.Api.Chat
{
	public abstract class ChatProvider : MonoBehaviour
	{
		...
		public Room GeneralRoom
		{
			get
			{
				return MyRooms.Find(room => room.Name.StartsWith("general"));
			}
		}
		...
		public Room GuildRoom
		{
			get
			{
				return MyRooms.Find(room => room.Name.StartsWith("group"));
			}
		}
		...
		public List<Room> DirectMessageRooms
		{
			get
			{
				return MyRooms.FindAll(room => room.Name.StartsWith("direct"));
			}
		}
		...
		public List<Room> AlwaysSubscribedRooms
		{
			get
			{
				return MyRooms.FindAll(room => room.KeepSubscribed);
			}
		}

...
namespace Beamable.Api
{
	public class AccessTokenStorage
	{
		...
		private string GetDeviceTokenKey(string cid, [CanBeNull] string pid) =>
			$"{_prefix}device-tokens{cid}{pid ?? ""}";
		...
		public Promise<AccessToken> LoadTokenForCustomer(string cid)
		{
			...
			return Promise<AccessToken>.Successful(
				new AccessToken(this, cid, null, accessToken, refreshToken, expires));
		}

...
namespace Beamable.Experimental.Api.Sim
{
	...
	public class SimClient
	{
		...
		private Dictionary<string, List<EventCallback<string>>> _eventCallbacks =
			new Dictionary<string, List<EventCallback<string>>>();
		...
		public EventCallback<string> OnInit(EventCallback<string> callback)
		{
			return OnInternal("init", "$system", callback);
		}

		public EventCallback<string> OnConnect(EventCallback<string> callback)
		{
			return OnInternal("connect", "$system", callback);
		}

		public EventCallback<string> OnDisconnect(EventCallback<string> callback)
		{
			return OnInternal("disconnect", "$system", callback);
		}

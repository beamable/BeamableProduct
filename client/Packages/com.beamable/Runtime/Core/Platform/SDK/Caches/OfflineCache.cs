...
namespace Beamable.Api.Caches
{
	public class OfflineCache
	{
		...
		private readonly static string _cid = Config.ConfigDatabase.HasKey("cid") ? Config.ConfigDatabase.GetString("cid") : null;
		private readonly static string _pid = Config.ConfigDatabase.HasKey("pid") ? Config.ConfigDatabase.GetString("pid") : null;

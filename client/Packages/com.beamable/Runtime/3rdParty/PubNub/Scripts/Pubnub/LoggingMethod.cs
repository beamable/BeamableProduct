...
namespace PubNubMessaging.Core
{
	...
	internal static class PubnubErrorCodeHelper
	{
		...
		public static PubnubErrorCode GetErrorType(Exception ex)
		{
			...
			else if (errorType.Equals("System.FormatException") && errorMessage.Equals(
	...
	internal static class PubnubErrorCodeDescription
	{
		...
		static PubnubErrorCodeDescription()
		{
			...
			dictionaryCodes.Add(
				4000,
				"If you must publish a message greater than the default of max message size of 1.8K (post-URLEncoded) please enable the elastic message size feature from your admin portal at admin.pubnub.com.");
			...
			dictionaryCodes.Add(
				4003, "No UUID specified. Please ensure that UUID is being passed to server for heartbeat");
			dictionaryCodes.Add(
				4004, "Invalid Timestamp. Please try again. If the issue continues, please contact PubNub support");
			dictionaryCodes.Add(4010, "Please provide a valid subscribe key");
			dictionaryCodes.Add(
				4020,
				"PAM is not enabled for this keyset. Please contact PubNub support for instructions on enabling PAM.");
			dictionaryCodes.Add(
				4030,
				"Not authorized. Please ensure that the channel has the correct PAM permission, your authentication key is set correctly, then try again via unsub and re-sub. For further assistance, contact PubNub support.");
			dictionaryCodes.Add(
				4031, "Please verify pub, sub, and secret keys. For assistance, contact PubNub support");
			dictionaryCodes.Add(
				4040,
				"HTTP 404 - Not Found Occured. Please try again. If the issue continues, please contact PubNub support");
			dictionaryCodes.Add(
				4140,
				"The URL request too long. Reduce the length by reducing subscription/presence channels or grant/revoke/audit channels/auth key list. Hint: You may spread the load across multiple PubNub instances to prevent this message.");
			dictionaryCodes.Add(
				5000, "Internal Server Error. Please try again. If the issue continues, please contact PubNub support");
			dictionaryCodes.Add(
				5020, "Bad Gateway. Please try again. If the issue continues, please contact PubNub support");
			dictionaryCodes.Add(
				5030, "Service Unavailable. Please try again. If the issue continues, please contact PubNub support");
			dictionaryCodes.Add(
				5040, "Gateway Timeout. Please try again. If the issue continues, please contact PubNub support");
			...
			dictionaryCodes.Add(
				105,
				"Web Request was cancelled due to change in subsciber/presence channel list or cancelled for object cleaning at the end of Pubnub object session");
			dictionaryCodes.Add(106, "Please check network/internet connection");
			dictionaryCodes.Add(
				107, "Internal exception. Please ignore"); //This won't go to callback. It will be suppressed.
			...
			dictionaryCodes.Add(
				110, "Network/internet connection is back. Active subscriber/presence channels will be restored.");
			dictionaryCodes.Add(
				111,
			...
			dictionaryCodes.Add(
				113, "Channel Already Presence-Subscribed. Duplicate channel presence-subscription not allowed");
			...
			dictionaryCodes.Add(
				122,
				"Network/Internet connection not available. Unity client is trying to verify connection. No action is needed from your side.");
			dictionaryCodes.Add(
				123,
			...
			dictionaryCodes.Add(
				129,
				"Error occured in external component. Please contact PubNub support with full error object details for further investigation");
			dictionaryCodes.Add(130, "Client machine is sleeping. Please check your machine.");
			dictionaryCodes.Add(
				131,
				"Timeout occured while setting user state. Please try again. If it continues, please contact PubNub support");
			dictionaryCodes.Add(
				132,
				"Timeout occured while getting user state. Please try again. If it continues, please contact PubNub support");
			dictionaryCodes.Add(
				133,
				"Timeout occured while running WhereNow. Please try again. If it continues, please contact PubNub support");
			dictionaryCodes.Add(
				134,
				"Timeout occured while running GlobalHereNow. Please try again. If it continues, please contact PubNub support");
			dictionaryCodes.Add(
				135,
				"Timeout occured while running PAM operations. Please try again. If it continues, please contact PubNub support");
			dictionaryCodes.Add(136, "User State Unchanged");
			dictionaryCodes.Add(
				137,
				"Timeout occured while registering device for push notifications. Please try again. If it continues, please contact PubNub support");
			dictionaryCodes.Add(138, "Operation Timeout.");
			dictionaryCodes.Add(
				139,
				"Timeout occured while performing operation related to channel group. Please try again. If it continues, please contact PubNub support");
			dictionaryCodes.Add(
				140,
				"Duplicate channel group subscription is not allowed. Internally Pubnub API removes the duplicates before processing");
			dictionaryCodes.Add(
				141,
				"WebExcepton. The underlying connection was closed: An unexpected error occurred on a receive. If it continues, please contact PubNub support");

...
namespace PubNubMessaging.Core
{
	...
	public class ChannelParameters
	{
		...
		public IDictionary<string, object> UserState
		{
			get;
			set;
		}
	...
	public sealed class Subscription
	{
		...
		public SafeDictionary<ChannelIdentity, ChannelParameters> ChannelEntitiesDictionary
		{
			get
			{
				return channelEntitiesDictionary;
			}
		}

		private SafeDictionary<ChannelIdentity, ChannelParameters> channelEntitiesDictionary =
			new SafeDictionary<ChannelIdentity, ChannelParameters>();
		...
		public void Add(ChannelEntity channelEntity, bool reset)
		{
			...
			else
			{
				...
				channelEntitiesDictionary[channelEntity.ChannelID].IsAwaitingConnectCallback =
					channelEntity.ChannelParams.IsAwaitingConnectCallback;
				channelEntitiesDictionary[channelEntity.ChannelID].IsSubscribed = true;
				channelEntitiesDictionary[channelEntity.ChannelID].TypeParameterType =
					channelEntity.ChannelParams.TypeParameterType;
				IDictionary<string, object> userState = channelEntitiesDictionary[channelEntity.ChannelID].UserState;
				if (userState == null)
				{
					channelEntitiesDictionary[channelEntity.ChannelID].UserState =
												 ...
												 bool edit)
		{
			...
			if (channelEntitiesDictionary.ContainsKey(channelEntity.ChannelID))
			{
				...
				{
					string oldState =
						Helpers.BuildJsonUserState(channelEntitiesDictionary[channelEntity.ChannelID].UserState);

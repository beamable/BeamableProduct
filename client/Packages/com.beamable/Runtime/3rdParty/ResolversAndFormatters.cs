	...
	public class UnityResolver : global::Utf8Json.IJsonFormatterResolver
	{
		...
		static class FormatterCache<T>
		{
			...
			static FormatterCache()
			{
				...
				{
					formatter = new UnityJsonFormatter<T>();
				}
			}
		}
	}
	...
	internal static class UnityResolverGetFormatterHelper
	{
		...
		static UnityResolverGetFormatterHelper()
		{
			lookup = new global::System.Collections.Generic.Dictionary<Type, int>(7)
			{
				...
				{typeof(OptionalInt), 21},
				{typeof(OptionalBoolean), 22},
				{typeof(OptionalDouble), 23},
				{typeof(OptionalLong), 24},
				{typeof(OptionalListInt), 25},
				{typeof(OptionalListString), 26},
				{typeof(OptionalString), 27},
			};
		}
		...
		internal static object GetFormatter(Type t)
		{
			...
			switch (key)
			{
				...
				case 14:
					return new Utf8Json.Formatters.StaticNullableFormatter<UnityEngine.Vector2>(
						new Utf8Json.Unity.Vector2Formatter());
				case 15:
					return new Utf8Json.Formatters.StaticNullableFormatter<UnityEngine.Vector3>(
						new Utf8Json.Unity.Vector3Formatter());
				case 16:
					return new Utf8Json.Formatters.StaticNullableFormatter<UnityEngine.Vector4>(
						new Utf8Json.Unity.Vector4Formatter());
				case 17:
					return new Utf8Json.Formatters.StaticNullableFormatter<UnityEngine.Quaternion>(
						new Utf8Json.Unity.QuaternionFormatter());
				case 18:
					return new Utf8Json.Formatters.StaticNullableFormatter<UnityEngine.Color>(
						new Utf8Json.Unity.ColorFormatter());
				case 19:
					return new Utf8Json.Formatters.StaticNullableFormatter<UnityEngine.Bounds>(
						new Utf8Json.Unity.BoundsFormatter());
				case 20:
					return new Utf8Json.Formatters.StaticNullableFormatter<UnityEngine.Rect>(
						new Utf8Json.Unity.RectFormatter());
				case 21: return new OptionalJsonFormatter<int, OptionalInt>();
				case 22: return new OptionalJsonFormatter<bool, OptionalBoolean>();
				case 23: return new OptionalJsonFormatter<double, OptionalDouble>();
				case 24: return new OptionalJsonFormatter<long, OptionalLong>();
				case 25: return new OptionalJsonFormatter<List<int>, OptionalListInt>();
				case 26: return new OptionalJsonFormatter<List<string>, OptionalListString>();
				case 27: return new OptionalJsonFormatter<string, OptionalString>();
				default: return null;
			}
		}
	}
...
namespace Utf8Json.Unity
{
	...
	public class OptionalJsonFormatter<T, U> : IJsonFormatter<U> where U : Optional<T>, new()
	{
		public void Serialize(ref JsonWriter writer, U value, IJsonFormatterResolver formatterResolver)
		{
		...
		U IJsonFormatter<U>.Deserialize(ref JsonReader reader, IJsonFormatterResolver formatterResolver)
		{
			var result = new U();
	...
	public class UnityJsonFormatter<T> : IJsonFormatter<T>
	{
	...
	public sealed class Vector2Formatter : global::Utf8Json.IJsonFormatter<global::UnityEngine.Vector2>
	{
		...
		public void Serialize(ref JsonWriter writer,
		                      ...
		                      global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
		...
		public global::UnityEngine.Vector2 Deserialize(ref JsonReader reader,
		                                               global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			if (reader.ReadIsNull())
			{
	...
	public sealed class Vector3Formatter : global::Utf8Json.IJsonFormatter<global::UnityEngine.Vector3>
	{
		...
		public global::UnityEngine.Vector3 Deserialize(ref JsonReader reader,
		                                               global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			if (reader.ReadIsNull())
			{
	...
	public sealed class Vector4Formatter : global::Utf8Json.IJsonFormatter<global::UnityEngine.Vector4>
	{
		...
		public global::UnityEngine.Vector4 Deserialize(ref JsonReader reader,
		                                               global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			if (reader.ReadIsNull())
			{
	...
	public sealed class QuaternionFormatter : global::Utf8Json.IJsonFormatter<global::UnityEngine.Quaternion>
	{
		...
		public global::UnityEngine.Quaternion Deserialize(ref JsonReader reader,
		                                                  global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			if (reader.ReadIsNull())
			{
	...
	public sealed class ColorFormatter : global::Utf8Json.IJsonFormatter<global::UnityEngine.Color>
	{
		...
		public void Serialize(ref JsonWriter writer,
		                      global::UnityEngine.Color value,
		                      global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			writer.WriteRaw(this.____stringByteKeys[0]);
		...
		public global::UnityEngine.Color Deserialize(ref JsonReader reader,
		                                             global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			if (reader.ReadIsNull())
			{
	...
	public sealed class BoundsFormatter : global::Utf8Json.IJsonFormatter<global::UnityEngine.Bounds>
	{
		...
		public void Serialize(ref JsonWriter writer,
		                      global::UnityEngine.Bounds value,
		                      global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			writer.WriteRaw(this.____stringByteKeys[0]);
			formatterResolver.GetFormatterWithVerify<global::UnityEngine.Vector3>()
			                 .Serialize(ref writer, value.center, formatterResolver);
			writer.WriteRaw(this.____stringByteKeys[1]);
			formatterResolver.GetFormatterWithVerify<global::UnityEngine.Vector3>()
			                 .Serialize(ref writer, value.size, formatterResolver);

			writer.WriteEndObject();
		}

		public global::UnityEngine.Bounds Deserialize(ref JsonReader reader,
		                                              global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			if (reader.ReadIsNull())
			{
			...
			while (!reader.ReadIsEndObjectWithSkipValueSeparator(ref ____count))
			{
				...
				{
					case 0:
						__center__ = formatterResolver.GetFormatterWithVerify<global::UnityEngine.Vector3>()
						                              .Deserialize(ref reader, formatterResolver);
						break;
					case 1:
						__size__ = formatterResolver.GetFormatterWithVerify<global::UnityEngine.Vector3>()
						                            .Deserialize(ref reader, formatterResolver);
						break;
					default:
						reader.ReadNextBlock();
	...
	public sealed class RectFormatter : global::Utf8Json.IJsonFormatter<global::UnityEngine.Rect>
	{
		...
		public global::UnityEngine.Rect Deserialize(ref JsonReader reader,
		                                            global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			if (reader.ReadIsNull())
			{

	...
	public class PlayerAccount : DefaultObservable, IUserContext
	{
		...
		public override int GetHashCode()
		{
			unchecked
			{
				...
				hashCode = (hashCode * 397) ^ (subtext != null ? subtext.GetHashCode() : 0);
				hashCode = (hashCode * 397) ^ gamerTag.GetHashCode();
				...
				hashCode = (hashCode * 397) ^ (thirdParties != null ? thirdParties.GetHashCode() : 0);
	...
	public class BeamableToken
	{
		...
		public override int GetHashCode()
		{
			unchecked
			{
				...
				hashCode = (hashCode * 397) ^ expiresIn.GetHashCode();

...
using LobbyQueryResponse = Beamable.Experimental.Api.Lobbies.LobbyQueryResponse;
using LobbyRestriction = Beamable.Experimental.Api.Lobbies.LobbyRestriction;
using Tag = Beamable.Experimental.Api.Lobbies.Tag;
...
namespace Beamable.Player
{
	...
	public class PlayerLobby : Observable<Lobby>, IDisposable
	{
		...
		/// <inheritdoc cref="Api.Autogenerated.Models.CreateLobby"/>
		...
		static OptionalUpdateData ConvertToUpdateData(IEnumerable<string> dataToRemove=null, Dictionary<string, string> dataToUpdate=null)
		{
			...
			{
				Value = new UpdateData()
			};
			if (dataToRemove != null)
			{
				data.Value.deletes.Value = dataToRemove.ToArray();
				data.Value.deletes.HasValue = true;
				data.HasValue = true;
			}

			if (dataToUpdate != null)
			{
				data.Value.updates.Value = new MapOfString(dataToUpdate);
				data.Value.updates.HasValue = true;
				data.HasValue = true;
			}
			return data;
		} 
